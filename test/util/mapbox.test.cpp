...
TEST(Mapbox, SourceURL) {
    ...
    EXPECT_EQ(
        ...
        "streets-v9@0",
        mbgl::util::mapbox::normalizeSourceURL(mapboxFixture::mapboxTileServerOptions,
...
TEST(Mapbox, StyleURL) {
    ...
    EXPECT_EQ("https://api.mapbox.com/styles/v1/user/style?access_token=key",
              mbgl::util::mapbox::normalizeStyleURL(
...
TEST(Mapbox, SpriteURL) {
    ...
    EXPECT_EQ("mapbox://////",
              mbgl::util::mapbox::normalizeSpriteURL(mapboxFixture::mapboxTileServerOptions, "mapbox://////", "key"));
}

TEST(Mapbox, TileURL) {
    EXPECT_EQ("https://api.mapbox.com/v4/a.b/0/0/0.pbf?access_token=key",
              mbgl::util::mapbox::normalizeTileURL(
    ...
    EXPECT_EQ(
        ...
        mbgl::util::mapbox::normalizeTileURL(mapboxFixture::mapboxTileServerOptions,
...
TEST(Mapbox, CanonicalURL) {
    EXPECT_EQ("mapbox://tiles/a.b/{z}/{x}/{y}.vector.pbf",
              mbgl::util::mapbox::canonicalizeTileURL(mapboxFixture::mapboxTileServerOptions,
...
TEST(MapTiler, StyleURL) {
    ...
    EXPECT_EQ("", mbgl::util::mapbox::normalizeStyleURL(mapboxFixture::mapTilerTileServerOptions, "", ""));
...
TEST(MapTiler, SourceURLPassThrough) {
    EXPECT_EQ("", mbgl::util::mapbox::normalizeSourceURL(mapboxFixture::mapTilerTileServerOptions, "", ""));
    ...
    EXPECT_EQ("", mbgl::util::mapbox::canonicalizeSourceURL(mapboxFixture::mapTilerTileServerOptions, ""));
}
...
TEST(MapTiler, GlyphsURLPassThrough) {
    EXPECT_EQ("", mbgl::util::mapbox::normalizeGlyphsURL(mapboxFixture::mapTilerTileServerOptions, "", ""));
    EXPECT_EQ("http://dummy",
    ...
    EXPECT_EQ("https://api.tileserver.com/map?key=1234",
              mbgl::util::mapbox::canonicalizeGlyphURL(mapboxFixture::mapTilerTileServerOptions,
                                                       "https://api.tileserver.com/map?key=1234"));
    EXPECT_EQ("", mbgl::util::mapbox::canonicalizeGlyphURL(mapboxFixture::mapTilerTileServerOptions, ""));
}
...
TEST(MapTiler, SpritesURLPassThrough) {
    EXPECT_EQ("", mbgl::util::mapbox::normalizeSpriteURL(mapboxFixture::mapTilerTileServerOptions, "", ""));
    EXPECT_EQ("http://dummy",
    ...
    EXPECT_EQ("https://api.tileserver.com/map?key=1234",
              mbgl::util::mapbox::canonicalizeSpriteURL(mapboxFixture::mapTilerTileServerOptions,
                                                        "https://api.tileserver.com/map?key=1234"));
    EXPECT_EQ("", mbgl::util::mapbox::canonicalizeSpriteURL(mapboxFixture::mapTilerTileServerOptions, ""));
}
...
TEST(MapTiler, Tiles) {
    ...
    EXPECT_EQ("maptiler://tiles/tiles/contours/{z}/{x}/{y}.pbf",
              mbgl::util::mapbox::canonicalizeTileURL(mapboxFixture::mapTilerTileServerOptions,
...
TEST(MapTiler, TilesURLPassThrough) {
    EXPECT_EQ("", mbgl::util::mapbox::normalizeTileURL(mapboxFixture::mapTilerTileServerOptions, "", ""));
    EXPECT_EQ("http://dummy",
