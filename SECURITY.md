...
6. `[Committer]` A new release is pushed out from the branch that now contains the fix. The release process is automated and documented and can be done by anyone with write access.
    ...
    - Android: [platform/android/RELEASE.md](https://github.com/idealprojects/maphero-native/blob/main/platform/android/RELEASE.md)
    - iOS: [platform/ios/RELEASE.md](https://github.com/idealprojects/maphero-native/blob/main/platform/android/RELEASE.md)

7. `[Maintainer]` The security advisory is [published](https://github.com/idealprojects/maphero-native/security/advisories?state=published).
