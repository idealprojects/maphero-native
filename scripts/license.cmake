...
function(mbgl_generate_license param)
    ...
    # cmake-format: on
        ...
        if(TARGET ${LIBRARY})
            get_target_property(NAME ${LIBRARY} INTERFACE_MAPHERO_NAME)
            get_target_property(URL ${LIBRARY} INTERFACE_MAPHERO_URL)
            get_target_property(AUTHOR ${LIBRARY} INTERFACE_MAPHERO_AUTHOR)
            get_target_property(LICENSE ${LIBRARY} INTERFACE_MAPHERO_LICENSE)
