...
#define DECLARE_MAPHERO_SETTING(name, value) constexpr const char* name = "MAPHERO_" #value

// The value for EXPERIMENTAL_THREAD_PRIORITY_* keys, must be a double.
DECLARE_MAPHERO_SETTING(EXPERIMENTAL_THREAD_PRIORITY_WORKER, thread_priority_worker);
DECLARE_MAPHERO_SETTING(EXPERIMENTAL_THREAD_PRIORITY_FILE, thread_priority_file);
DECLARE_MAPHERO_SETTING(EXPERIMENTAL_THREAD_PRIORITY_NETWORK, thread_priority_network);
DECLARE_MAPHERO_SETTING(EXPERIMENTAL_THREAD_PRIORITY_DATABASE, thread_priority_database);
