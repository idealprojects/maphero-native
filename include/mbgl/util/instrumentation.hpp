...
#if !defined(MH_RENDER_BACKEND_OPENGL) && !defined(MH_RENDER_BACKEND_VULKAN)
#error \
    "MH_RENDER_BACKEND_OPENGL/MH_RENDER_BACKEND_VULKAN is not defined. \
    MH_RENDER_BACKEND_OPENGL/MH_RENDER_BACKEND_VULKAN is expected to be defined in CMake and Bazel"
#endif
