...
Demonstrates using ``MHPolyline/polylineWithCoordinates:count:`` to update an ``MHPolyline``.


<!-- include-example(AnimatedLineExample) -->
...
This map uses data from OpenStreetMap, the style uses OpenMapTiles.