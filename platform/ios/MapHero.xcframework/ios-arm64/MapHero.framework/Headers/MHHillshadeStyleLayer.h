...
/**
 ...
 Values of this type are used in the ``MHHillshadeStyleLayer/hillshadeIlluminationAnchor``
 property.
 */
typedef NS_ENUM(NSUInteger, MHHillshadeIlluminationAnchor) {
    /**
...
/**
 An ``MHHillshadeStyleLayer`` is a style layer that renders raster <a
 ...
 loaded by an ``MHHillshadeStyleLayer`` object. For example, you could use a
 ...
 source, use an ``MHHillshadeStyleLayer`` object in conjunction with several
 ``MHHillshadeStyleLayer`` objects.
 ...
 */
MH_EXPORT
@interface MHHillshadeStyleLayer : MHForegroundStyleLayer
...
*/
@property (nonatomic) MHTransition hillshadeAccentColorTransition;
...
*/
@property (nonatomic) MHTransition hillshadeExaggerationTransition;
...
*/
@property (nonatomic) MHTransition hillshadeHighlightColorTransition;
 ...
 * Constant `MHHillshadeIlluminationAnchor` values
...
/**
 ...
 `MHHillshadeIlluminationAnchorViewport` and due north if
 `hillshadeIlluminationAnchor` is set to `MHHillshadeIlluminationAnchorMap`.
...
*/
@property (nonatomic) MHTransition hillshadeShadowColorTransition;

@end

/**
 Methods for wrapping an enumeration value for a style layer attribute in an
 ``MHHillshadeStyleLayer`` object and unwrapping its raw value.
 */
@interface NSValue (MHHillshadeStyleLayerAdditions)

// MARK: Working with Hillshade Style Layer Attribute Values

/**
 Creates a new value object containing the given `MHHillshadeIlluminationAnchor` enumeration.

 @param hillshadeIlluminationAnchor The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHHillshadeIlluminationAnchor:(MHHillshadeIlluminationAnchor)hillshadeIlluminationAnchor;

/**
 The ``MHHillshadeIlluminationAnchor`` enumeration representation of the value.
 */
@property (readonly) MHHillshadeIlluminationAnchor MHHillshadeIlluminationAnchorValue;
