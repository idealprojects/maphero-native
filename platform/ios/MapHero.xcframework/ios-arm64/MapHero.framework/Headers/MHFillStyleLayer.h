...
/**
 Controls the frame of reference for ``MHFillStyleLayer/fillTranslation``.

 Values of this type are used in the ``MHFillStyleLayer/fillTranslationAnchor``
 property.
 */
typedef NS_ENUM(NSUInteger, MHFillTranslationAnchor) {
    /**
...
/**
 An ``MHFillStyleLayer`` is a style layer that renders one or more filled (and
 ...
 ``MHFillStyleLayer`` object, or they can be ``MHFillStyleLayer``,
 ``MHFillStyleLayer``, ``MHFillStyleLayer``, or ``MHFillStyleLayer`` instances
 in an ``MHFillStyleLayer`` or ``MHFillStyleLayer`` object.
 ...
 the `fillOpacity` of an ``MHFillStyleLayer`` object. See the <a
 ...
 features styled by a ``MHFillStyleLayer``.
 ...
 */
MH_EXPORT
@interface MHFillStyleLayer : MHVectorStyleLayer
...
*/
@property (nonatomic) MHTransition fillColorTransition;
...
*/
@property (nonatomic) MHTransition fillOpacityTransition;
...
*/
@property (nonatomic) MHTransition fillOutlineColorTransition;
...
*/
@property (nonatomic) MHTransition fillPatternTransition;
...
*/
@property (nonatomic) MHTransition fillTranslationTransition;
 ...
 * Constant `MHFillTranslationAnchor` values
...
/**
 ...
 ``MHFillStyleLayer`` object and unwrapping its raw value.
 */
@interface NSValue (MHFillStyleLayerAdditions)

// MARK: Working with Fill Style Layer Attribute Values

/**
 Creates a new value object containing the given `MHFillTranslationAnchor` enumeration.

 @param fillTranslationAnchor The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHFillTranslationAnchor:(MHFillTranslationAnchor)fillTranslationAnchor;

/**
 The ``MHFillTranslationAnchor`` enumeration representation of the value.
 */
@property (readonly) MHFillTranslationAnchor MHFillTranslationAnchorValue;
