...
/**
 ...
 Values of this type are used in the ``MHRasterStyleLayer/rasterResamplingMode``
 property.
 */
typedef NS_ENUM(NSUInteger, MHRasterResamplingMode) {
    /**
...
/**
 An ``MHRasterStyleLayer`` is a style layer that renders georeferenced raster
 imagery on the map, especially raster tiles.
 
 Use a raster style layer to configure the color parameters of raster tiles
 loaded by an ``MHRasterStyleLayer`` object or raster images loaded by an
 ``MHRasterStyleLayer`` object. For example, you could use a raster style layer
 ...
 ``MHStyle/setImage:forName:`` method. To configure a point annotation’s image,
 use the ``MHRasterStyleLayer`` class.
 ...
 */
MH_EXPORT
@interface MHRasterStyleLayer : MHForegroundStyleLayer
...
*/
@property (nonatomic) MHTransition maximumRasterBrightnessTransition;
...
*/
@property (nonatomic) MHTransition minimumRasterBrightnessTransition;
...
*/
@property (nonatomic) MHTransition rasterContrastTransition;
...
*/
@property (nonatomic) MHTransition rasterHueRotationTransition;
...
*/
@property (nonatomic) MHTransition rasterOpacityTransition;
 ...
 * Constant `MHRasterResamplingMode` values
...
*/
@property (nonatomic) MHTransition rasterSaturationTransition;

@end

/**
 Methods for wrapping an enumeration value for a style layer attribute in an
 ``MHRasterStyleLayer`` object and unwrapping its raw value.
 */
@interface NSValue (MHRasterStyleLayerAdditions)

// MARK: Working with Raster Style Layer Attribute Values

/**
 Creates a new value object containing the given `MHRasterResamplingMode` enumeration.

 @param rasterResamplingMode The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHRasterResamplingMode:(MHRasterResamplingMode)rasterResamplingMode;

/**
 The ``MHRasterResamplingMode`` enumeration representation of the value.
 */
@property (readonly) MHRasterResamplingMode MHRasterResamplingModeValue;
