...
/**
 The ``MHTileServerOptions`` defines server properties such as URL etc...
 */
MH_EXPORT
@interface MHTileServerOptions : NSObject
 ...
 * Default styles.
 */
@property (nonatomic, retain) NSArray<MHDefaultStyle*>* defaultStyles;

/**
 * Default style
 */
@property (nonatomic, retain) MHDefaultStyle* defaultStyle;
