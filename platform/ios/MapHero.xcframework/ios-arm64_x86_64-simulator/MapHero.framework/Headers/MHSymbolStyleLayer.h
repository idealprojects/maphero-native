...
/**
 ...
 Values of this type are used in the ``MHSymbolStyleLayer/iconAnchor``
 property.
 */
typedef NS_ENUM(NSUInteger, MHIconAnchor) {
    /**
...
/**
 ...
 Values of this type are used in the ``MHSymbolStyleLayer/iconPitchAlignment``
 property.
 */
typedef NS_ENUM(NSUInteger, MHIconPitchAlignment) {
    /**
...
/**
 In combination with ``MHSymbolStyleLayer/symbolPlacement``, determines the
 rotation behavior of icons.

 Values of this type are used in the ``MHSymbolStyleLayer/iconRotationAlignment``
 property.
 */
typedef NS_ENUM(NSUInteger, MHIconRotationAlignment) {
    /**
     When `symbolPlacement` is set to `MHSymbolPlacementPoint`, aligns icons
...
/**
 ...
 Values of this type are used in the ``MHSymbolStyleLayer/iconTextFit``
 property.
 */
typedef NS_ENUM(NSUInteger, MHIconTextFit) {
    /**
...
/**
 ...
 Values of this type are used in the ``MHSymbolStyleLayer/symbolPlacement``
 property.
 */
typedef NS_ENUM(NSUInteger, MHSymbolPlacement) {
    /**
...
/**
 ...
 ``MHSymbolStyleLayer/symbolSortKey``.

 Values of this type are used in the ``MHSymbolStyleLayer/symbolZOrder``
 property.
 */
typedef NS_ENUM(NSUInteger, MHSymbolZOrder) {
    /**
     Sorts symbols by ``MHSymbolStyleLayer/symbolSortKey`` if set. Otherwise,
...
/**
 ...
 Values of this type are used in the ``MHSymbolStyleLayer/textAnchor``
 property.
 */
typedef NS_ENUM(NSUInteger, MHTextAnchor) {
    /**
...
/**
 ...
 Values of this type are used in the ``MHSymbolStyleLayer/textJustification``
 property.
 */
typedef NS_ENUM(NSUInteger, MHTextJustification) {
    /**
...
/**
 ...
 Values of this type are used in the ``MHSymbolStyleLayer/textPitchAlignment``
 property.
 */
typedef NS_ENUM(NSUInteger, MHTextPitchAlignment) {
    /**
...
/**
 ...
 Values of this type are used in the ``MHSymbolStyleLayer/textRotationAlignment``
 property.
 */
typedef NS_ENUM(NSUInteger, MHTextRotationAlignment) {
    /**
     When `symbolPlacement` is set to `MHSymbolPlacementPoint`, aligns text
     east-west. When `symbolPlacement` is set to `MHSymbolPlacementLine` or
...
/**
 ...
 Values of this type are used in the ``MHSymbolStyleLayer/textTransform``
 property.
 */
typedef NS_ENUM(NSUInteger, MHTextTransform) {
    /**
...
/**
 ...
 Values of this type are used in the ``MHSymbolStyleLayer/textWritingModes``
 property.
 */
typedef NS_ENUM(NSUInteger, MHTextWritingMode) {
    /**
...
/**
 Controls the frame of reference for ``MHSymbolStyleLayer/iconTranslation``.

 Values of this type are used in the ``MHSymbolStyleLayer/iconTranslationAnchor``
 property.
 */
typedef NS_ENUM(NSUInteger, MHIconTranslationAnchor) {
    /**
...
/**
 Controls the frame of reference for ``MHSymbolStyleLayer/textTranslation``.

 Values of this type are used in the ``MHSymbolStyleLayer/textTranslationAnchor``
 property.
 */
typedef NS_ENUM(NSUInteger, MHTextTranslationAnchor) {
    /**
...
/**
 An ``MHSymbolStyleLayer`` is a style layer that renders icon and text labels at
 points or along lines on the map.
 
 Use a symbol style layer to configure the visual appearance of feature labels.
 These features can come from vector tiles loaded by an ``MHSymbolStyleLayer``
 object, or they can be ``MHSymbolStyleLayer`` or ``MHSymbolStyleLayer``
 instances in an ``MHSymbolStyleLayer`` or ``MHSymbolStyleLayer`` object.
 ...
 */
MH_EXPORT
@interface MHSymbolStyleLayer : MHVectorStyleLayer
...
/**
 ...
 Use the ``MHStyle/setImage:forName:`` method to associate an image with a name
 ...
 * Constant `MHIconPitchAlignment` values
 * Any of the following constant string values:
 ...
 * Constant `MHIconRotationAlignment` values
 * Any of the following constant string values:
...
/**
 ...
 to `MHIconTextFitBoth`, `MHIconTextFitWidth`, or `MHIconTextFitHeight`.
 Otherwise, it is ignored.
...
/**
 ...
 `MHSymbolPlacementLine` or `MHSymbolPlacementLineCenter`. Otherwise, it is
 ignored.
...
/**
 ...
 ``MHSymbolPlacement/MHSymbolPlacementPoint`` but this layer is above a symbol
 layer whose `symbolPlacement` property is set to
 ``MHSymbolPlacement/MHSymbolPlacementPoint``. You do not need to enable this
 ...
 * Constant `MHSymbolPlacement` values
 * Any of the following constant string values:
 ...
 * Constant `MHSymbolZOrder` values
 * Any of the following constant string values:
 ...
 * Constant `MHTextJustification` values
 * Any of the following constant string values:
 ...
 * Constant `MHTextPitchAlignment` values
 * Any of the following constant string values:
 ...
 * Constant `MHTextRotationAlignment` values
 * Any of the following constant string values:
 ...
 * Constant `MHTextTransform` values
 * Any of the following constant string values:
 ...
 * Constant ``MHTextAnchor`` array values
 ...
 * Constant ``MHTextWritingMode`` array values
 * Constant array, in which each element is any of the following constant string
 values:
...
*/
@property (nonatomic) MHTransition iconColorTransition;
...
*/
@property (nonatomic) MHTransition iconHaloBlurTransition;
...
*/
@property (nonatomic) MHTransition iconHaloColorTransition;
...
*/
@property (nonatomic) MHTransition iconHaloWidthTransition;
...
*/
@property (nonatomic) MHTransition iconOpacityTransition;
...
*/
@property (nonatomic) MHTransition iconTranslationTransition;
 ...
 * Constant `MHIconTranslationAnchor` values
 * Any of the following constant string values:
...
*/
@property (nonatomic) MHTransition textColorTransition;
...
*/
@property (nonatomic) MHTransition textHaloBlurTransition;
...
*/
@property (nonatomic) MHTransition textHaloColorTransition;
...
*/
@property (nonatomic) MHTransition textHaloWidthTransition;
...
*/
@property (nonatomic) MHTransition textOpacityTransition;
...
*/
@property (nonatomic) MHTransition textTranslationTransition;
 ...
 * Constant `MHTextTranslationAnchor` values
 * Any of the following constant string values:
...
/**
 ...
 ``MHSymbolStyleLayer`` object and unwrapping its raw value.
 */
@interface NSValue (MHSymbolStyleLayerAdditions)

// MARK: Working with Symbol Style Layer Attribute Values

/**
 Creates a new value object containing the given `MHIconAnchor` enumeration.

 @param iconAnchor The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHIconAnchor:(MHIconAnchor)iconAnchor;

/**
 The ``MHIconAnchor`` enumeration representation of the value.
 */
@property (readonly) MHIconAnchor MHIconAnchorValue;

/**
 Creates a new value object containing the given `MHIconPitchAlignment` enumeration.

 @param iconPitchAlignment The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHIconPitchAlignment:(MHIconPitchAlignment)iconPitchAlignment;

/**
 The ``MHIconPitchAlignment`` enumeration representation of the value.
 */
@property (readonly) MHIconPitchAlignment MHIconPitchAlignmentValue;

/**
 Creates a new value object containing the given `MHIconRotationAlignment` enumeration.

 @param iconRotationAlignment The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHIconRotationAlignment:(MHIconRotationAlignment)iconRotationAlignment;

/**
 The ``MHIconRotationAlignment`` enumeration representation of the value.
 */
@property (readonly) MHIconRotationAlignment MHIconRotationAlignmentValue;

/**
 Creates a new value object containing the given `MHIconTextFit` enumeration.

 @param iconTextFit The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHIconTextFit:(MHIconTextFit)iconTextFit;

/**
 The ``MHIconTextFit`` enumeration representation of the value.
 */
@property (readonly) MHIconTextFit MHIconTextFitValue;

/**
 Creates a new value object containing the given `MHSymbolPlacement` enumeration.

 @param symbolPlacement The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHSymbolPlacement:(MHSymbolPlacement)symbolPlacement;

/**
 The ``MHSymbolPlacement`` enumeration representation of the value.
 */
@property (readonly) MHSymbolPlacement MHSymbolPlacementValue;

/**
 Creates a new value object containing the given `MHSymbolZOrder` enumeration.

 @param symbolZOrder The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHSymbolZOrder:(MHSymbolZOrder)symbolZOrder;

/**
 The ``MHSymbolZOrder`` enumeration representation of the value.
 */
@property (readonly) MHSymbolZOrder MHSymbolZOrderValue;

/**
 Creates a new value object containing the given `MHTextAnchor` enumeration.

 @param textAnchor The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHTextAnchor:(MHTextAnchor)textAnchor;

/**
 The ``MHTextAnchor`` enumeration representation of the value.
 */
@property (readonly) MHTextAnchor MHTextAnchorValue;

/**
 Creates a new value object containing the given `MHTextJustification` enumeration.

 @param textJustification The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHTextJustification:(MHTextJustification)textJustification;

/**
 The ``MHTextJustification`` enumeration representation of the value.
 */
@property (readonly) MHTextJustification MHTextJustificationValue;

/**
 Creates a new value object containing the given `MHTextPitchAlignment` enumeration.

 @param textPitchAlignment The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHTextPitchAlignment:(MHTextPitchAlignment)textPitchAlignment;

/**
 The ``MHTextPitchAlignment`` enumeration representation of the value.
 */
@property (readonly) MHTextPitchAlignment MHTextPitchAlignmentValue;

/**
 Creates a new value object containing the given `MHTextRotationAlignment` enumeration.

 @param textRotationAlignment The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHTextRotationAlignment:(MHTextRotationAlignment)textRotationAlignment;

/**
 The ``MHTextRotationAlignment`` enumeration representation of the value.
 */
@property (readonly) MHTextRotationAlignment MHTextRotationAlignmentValue;

/**
 Creates a new value object containing the given `MHTextTransform` enumeration.

 @param textTransform The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHTextTransform:(MHTextTransform)textTransform;

/**
 The ``MHTextTransform`` enumeration representation of the value.
 */
@property (readonly) MHTextTransform MHTextTransformValue;

/**
 Creates a new value object containing the given `MHTextWritingMode` enumeration.

 @param textWritingModes The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHTextWritingMode:(MHTextWritingMode)textWritingModes;

/**
 The ``MHTextWritingMode`` enumeration representation of the value.
 */
@property (readonly) MHTextWritingMode MHTextWritingModeValue;

/**
 Creates a new value object containing the given `MHIconTranslationAnchor` enumeration.

 @param iconTranslationAnchor The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHIconTranslationAnchor:(MHIconTranslationAnchor)iconTranslationAnchor;

/**
 The ``MHIconTranslationAnchor`` enumeration representation of the value.
 */
@property (readonly) MHIconTranslationAnchor MHIconTranslationAnchorValue;

/**
 Creates a new value object containing the given `MHTextTranslationAnchor` enumeration.

 @param textTranslationAnchor The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHTextTranslationAnchor:(MHTextTranslationAnchor)textTranslationAnchor;

/**
 The ``MHTextTranslationAnchor`` enumeration representation of the value.
 */
@property (readonly) MHTextTranslationAnchor MHTextTranslationAnchorValue;
