...
@class MHMapView;
@class MHUserLocationAnnotationViewStyle;

/**
 The ``MHMapViewDelegate`` protocol defines a set of optional methods that you
 can use to receive map-related update messages. Because many map operations
 require the ``MHMapView`` class to load data asynchronously, the map view calls
 ...
 */
@protocol MHMapViewDelegate <NSObject>
 ...
 */
- (BOOL)mapView:(MHMapView *)mapView
    shouldChangeFromCamera:(MHMapCamera *)oldCamera
                  toCamera:(MHMapCamera *)newCamera;
...
- (BOOL)mapView:(MHMapView *)mapView
    shouldChangeFromCamera:(MHMapCamera *)oldCamera
                  toCamera:(MHMapCamera *)newCamera
                    reason:(MHCameraChangeReason)reason;
...
- (void)mapView:(MHMapView *)mapView
    regionWillChangeWithReason:(MHCameraChangeReason)reason
...
/**
 ...
 as ``MHMapView/setCamera:animated:``. This method can be called before
 ...
 */
- (void)mapView:(MHMapView *)mapView regionIsChangingWithReason:(MHCameraChangeReason)reason;
 ...
 */
- (void)mapView:(MHMapView *)mapView regionDidChangeAnimated:(BOOL)animated;
 ...
 */
- (void)mapView:(MHMapView *)mapView
    regionDidChangeWithReason:(MHCameraChangeReason)reason
                     animated:(BOOL)animated;
 ...
 */
- (void)mapViewWillStartLoadingMap:(MHMapView *)mapView;
 ...
 */
- (void)mapViewDidFinishLoadingMap:(MHMapView *)mapView;
...
// TODO
- (void)mapViewWillStartRenderingMap:(MHMapView *)mapView;

// TODO
- (void)mapViewDidFinishRenderingMap:(MHMapView *)mapView fullyRendered:(BOOL)fullyRendered;
 ...
 */
- (void)mapViewWillStartRenderingFrame:(MHMapView *)mapView;
 ...
 */
- (void)mapViewDidFinishRenderingFrame:(MHMapView *)mapView fullyRendered:(BOOL)fullyRendered;
/**
 Tells the delegate that the map view has just redrawn.
...
- (void)mapViewDidFinishRenderingFrame:(MHMapView *)mapView
                         fullyRendered:(BOOL)fullyRendered
                        renderingStats:(MHRenderingStats *)renderingStats;
 ...
 */
- (void)mapViewDidBecomeIdle:(MHMapView *)mapView;
...
/**
 ...
 with ``MHStyle/setImage:forName:`` to be rendered on the current zoom level. When loading icons
 ...
 */
- (nullable UIImage *)mapView:(MHMapView *)mapView didFailToLoadImage:(NSString *)imageName;
...
/**
 ...
 the cached image.
 */
- (BOOL)mapView:(MHMapView *)mapView shouldRemoveStyleImage:(NSString *)imageName;
...
/**
 ...
 @param mapView The ``MHMapView`` instance invoking this delegate method.
...
@param mapView The ``MHMapView`` instance invoking this delegate method.
@param operation The type of tile operation triggered. See ``MHTileOperation``.
...
> Warning: This method is not thread-safe.
*/
- (void)mapView:(MHMapView *)mapView spriteDidError:(NSString *)id url:(NSString *)url;
 ...
 */
- (void)mapViewWillStartLocatingUser:(MHMapView *)mapView;
...
/**
 ...
 @param mapView The map view that is tracking the user’s location.
 */
- (void)mapViewDidStopLocatingUser:(MHMapView *)mapView;
...
/**
 ...
 @param mapView The map view that is tracking the user’s location.
 */
- (MHUserLocationAnnotationViewStyle *)mapViewStyleForDefaultUserLocationAnnotationView:
    (MHMapView *)mapView NS_SWIFT_NAME(mapView(styleForDefaultUserLocationAnnotationView:));
...
/**
 ...
 ``MHUserTrackingMode/MHUserTrackingModeFollowWithHeading`` and the heading changes, or if it is
 set to ``MHUserTrackingMode/MHUserTrackingModeFollowWithCourse`` and the course changes.
 ...
 */
- (void)mapView:(MHMapView *)mapView
    didUpdateUserLocation:(nullable MHUserLocation *)userLocation;
...
/**
 ...
 @param error An error object containing the reason why location tracking
    failed.
 */
- (void)mapView:(MHMapView *)mapView didFailToLocateUserWithError:(NSError *)error;
 ...
 */
- (void)mapView:(MHMapView *)mapView
    didChangeUserTrackingMode:(MHUserTrackingMode)mode
                     animated:(BOOL)animated;
...
/**
 ...
 This method will override any values set by ``MHMapView/userLocationVerticalAlignment``
 or ``MHMapView/setUserLocationVerticalAlignment:animated:``.
 ...
 */
- (void)mapView:(MHMapView *)mapView
    didChangeLocationManagerAuthorization:(id<MHLocationManager>)manager API_AVAILABLE(ios(14));
...
/**
 ...
 image should be used for ``MHAnnotation`` objects that have been added to
 your map
 */
- (nullable MHAnnotationImage *)mapView:(MHMapView *)mapView
...
/**
 ...
 ``MHShape`` object that has been added to your map as an annotation.
 */
- (UIColor *)mapView:(MHMapView *)mapView strokeColorForShapeAnnotation:(MHShape *)annotation;
...
/**
 ...
 ``MHPolygon`` at runtime.
 */
- (UIColor *)mapView:(MHMapView *)mapView fillColorForPolygonAnnotation:(MHPolygon *)annotation;
...
/**
 ...
 line width of an ``MHPolylineFeature`` on your map.
 */
- (CGFloat)mapView:(MHMapView *)mapView lineWidthForPolylineAnnotation:(MHPolyline *)annotation;
...
/**
 ...
 `annotation` is an instance of ``MHUserLocation`` (or equal to the map view’s
 `userLocation` property), return an instance of ``MHUserLocationAnnotationView``
 ...
 ``MHAnnotation`` to use for a given ``MHAnnotation`` object on your
 map.
 */
- (nullable MHAnnotationView *)mapView:(MHMapView *)mapView
                      viewForAnnotation:(id<MHAnnotation>)annotation;
...
/**
 ...
 @param annotationViews An array of ``MHAnnotationView`` objects representing the
    views that were added.
 */
- (void)mapView:(MHMapView *)mapView
    didAddAnnotationViews:(NSArray<MHAnnotationView *> *)annotationViews;
 ...
 */
- (BOOL)mapView:(MHMapView *)mapView shapeAnnotationIsEnabled:(MHShape *)annotation;
 ...
 */
- (void)mapView:(MHMapView *)mapView didSelectAnnotationView:(MHAnnotationView *)annotationView;
 ...
 */
- (void)mapView:(MHMapView *)mapView didDeselectAnnotationView:(MHAnnotationView *)annotationView;
...
/**
 ...
 @param annotation The object representing the annotation.
 @return A view conforming to the ``MHCalloutView`` protocol, or `nil` to use the
    default callout view.

 #### Related examples
 TODO: Display custom views as callouts, learn how to customize an
 ``MHAnnotation`` object's ``MHAnnotation``.
 */
- (nullable id<MHCalloutView>)mapView:(MHMapView *)mapView
              calloutViewForAnnotation:(id<MHAnnotation>)annotation;
 ...
 */
- (nullable UIView *)mapView:(MHMapView *)mapView
    leftCalloutAccessoryViewForAnnotation:(id<MHAnnotation>)annotation;
 ...
 */
- (nullable UIView *)mapView:(MHMapView *)mapView
    rightCalloutAccessoryViewForAnnotation:(id<MHAnnotation>)annotation;
...
/**
 ...
 custom accessory views using the ``MHCalloutView`` protocol’s
 ...
 */
- (void)mapView:(MHMapView *)mapView
                       annotation:(id<MHAnnotation>)annotation
...
/**
 ...
 ``MHCalloutViewDelegate/calloutViewTapped:`` method.
 ...
 action when an ``MHAnnotation``s ``MHAnnotation`` is tapped.
 */
