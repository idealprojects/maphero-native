...
/**
 ...
 Values of this type are used in the ``MHLineStyleLayer/lineCap``
 property.
 */
typedef NS_ENUM(NSUInteger, MHLineCap) {
    /**
...
/**
 ...
 Values of this type are used in the ``MHLineStyleLayer/lineJoin``
 property.
 */
typedef NS_ENUM(NSUInteger, MHLineJoin) {
    /**
...
/**
 Controls the frame of reference for ``MHLineStyleLayer/lineTranslation``.

 Values of this type are used in the ``MHLineStyleLayer/lineTranslationAnchor``
 property.
 */
typedef NS_ENUM(NSUInteger, MHLineTranslationAnchor) {
    /**
...
/**
 An ``MHLineStyleLayer`` is a style layer that renders one or more stroked
 ...
 ``MHLineStyleLayer`` object, or they can be ``MHLineStyleLayer``,
 ``MHLineStyleLayer``, ``MHLineStyleLayer``, or ``MHLineStyleLayer`` instances
 in an ``MHLineStyleLayer`` or ``MHLineStyleLayer`` object.
 ...
 an ``MHMapView`` object at runtime.
 ...
 */
MH_EXPORT
@interface MHLineStyleLayer : MHVectorStyleLayer
...
*/
@property (nonatomic) MHTransition lineBlurTransition;
...
*/
@property (nonatomic) MHTransition lineColorTransition;
...
*/
@property (nonatomic) MHTransition lineDashPatternTransition;
...
*/
@property (nonatomic) MHTransition lineGapWidthTransition;

#if TARGET_OS_IPHONE
/**
 The color gradient with which the line will be drawn. This property only has an
 effect on lines defined by an ``MHShapeSource`` whose ``MHShapeSource`` option
 is set to `YES`.
...
*/
@property (nonatomic) MHTransition lineOffsetTransition;
...
*/
@property (nonatomic) MHTransition lineOpacityTransition;
...
*/
@property (nonatomic) MHTransition linePatternTransition;
...
*/
@property (nonatomic) MHTransition lineTranslationTransition;
 ...
 * Constant `MHLineTranslationAnchor` values
 * Any of the following constant string values:
...
*/
@property (nonatomic) MHTransition lineWidthTransition;

@end

/**
 Methods for wrapping an enumeration value for a style layer attribute in an
 ``MHLineStyleLayer`` object and unwrapping its raw value.
 */
@interface NSValue (MHLineStyleLayerAdditions)

// MARK: Working with Line Style Layer Attribute Values

/**
 Creates a new value object containing the given `MHLineCap` enumeration.

 @param lineCap The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHLineCap:(MHLineCap)lineCap;

/**
 The ``MHLineCap`` enumeration representation of the value.
 */
@property (readonly) MHLineCap MHLineCapValue;

/**
 Creates a new value object containing the given `MHLineJoin` enumeration.

 @param lineJoin The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHLineJoin:(MHLineJoin)lineJoin;

/**
 The ``MHLineJoin`` enumeration representation of the value.
 */
@property (readonly) MHLineJoin MHLineJoinValue;

/**
 Creates a new value object containing the given `MHLineTranslationAnchor` enumeration.

 @param lineTranslationAnchor The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHLineTranslationAnchor:(MHLineTranslationAnchor)lineTranslationAnchor;

/**
 The ``MHLineTranslationAnchor`` enumeration representation of the value.
 */
@property (readonly) MHLineTranslationAnchor MHLineTranslationAnchorValue;
