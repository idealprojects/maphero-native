...
/**
 An ``MHBackgroundStyleLayer`` is a style layer that covers the entire map. Use
 ...
 and other bodies of water are drawn by ``MHBackgroundStyleLayer`` objects.
 ...
 access it by getting the last item in the ``MHStyle/layers`` array.
 ...
 */
MH_EXPORT
@interface MHBackgroundStyleLayer : MHStyleLayer
...
*/
@property (nonatomic) MHTransition backgroundColorTransition;
...
*/
@property (nonatomic) MHTransition backgroundOpacityTransition;
...
*/
@property (nonatomic) MHTransition backgroundPatternTransition;
