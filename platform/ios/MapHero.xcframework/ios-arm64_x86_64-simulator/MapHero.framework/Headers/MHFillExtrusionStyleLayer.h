...
/**
 ...
 ``MHFillExtrusionStyleLayer/fillExtrusionTranslation``.

 Values of this type are used in the ``MHFillExtrusionStyleLayer/fillExtrusionTranslationAnchor``
 property.
 */
typedef NS_ENUM(NSUInteger, MHFillExtrusionTranslationAnchor) {
    /**
...
/**
 An ``MHFillExtrusionStyleLayer`` is a style layer that renders one or more 3D
 ...
 an ``MHFillExtrusionStyleLayer`` object, or they can be
 ``MHFillExtrusionStyleLayer``, ``MHFillExtrusionStyleLayer``,
 ``MHFillExtrusionStyleLayer``, or ``MHFillExtrusionStyleLayer`` instances in an
 ``MHFillExtrusionStyleLayer`` or ``MHFillExtrusionStyleLayer`` object.
 ...
 */
MH_EXPORT
@interface MHFillExtrusionStyleLayer : MHVectorStyleLayer
...
*/
@property (nonatomic) MHTransition fillExtrusionBaseTransition;
...
*/
@property (nonatomic) MHTransition fillExtrusionColorTransition;
...
*/
@property (nonatomic) MHTransition fillExtrusionHeightTransition;
...
*/
@property (nonatomic) MHTransition fillExtrusionOpacityTransition;
...
*/
@property (nonatomic) MHTransition fillExtrusionPatternTransition;
...
*/
@property (nonatomic) MHTransition fillExtrusionTranslationTransition;
 ...
 * Constant `MHFillExtrusionTranslationAnchor` values
...
/**
 ...
 ``MHFillExtrusionStyleLayer`` object and unwrapping its raw value.
 */
@interface NSValue (MHFillExtrusionStyleLayerAdditions)

// MARK: Working with Fill extrusion Style Layer Attribute Values

/**
 Creates a new value object containing the given `MHFillExtrusionTranslationAnchor` enumeration.

 @param fillExtrusionTranslationAnchor The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHFillExtrusionTranslationAnchor:(MHFillExtrusionTranslationAnchor)fillExtrusionTranslationAnchor;

/**
 The ``MHFillExtrusionTranslationAnchor`` enumeration representation of the value.
 */
@property (readonly) MHFillExtrusionTranslationAnchor MHFillExtrusionTranslationAnchorValue;
