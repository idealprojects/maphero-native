...
/**
 ...
 Values of this type are used in the ``MHCircleStyleLayer/circlePitchAlignment``
 property.
 */
typedef NS_ENUM(NSUInteger, MHCirclePitchAlignment) {
    /**
...
/**
 ...
 Values of this type are used in the ``MHCircleStyleLayer/circleScaleAlignment``
 property.
 */
typedef NS_ENUM(NSUInteger, MHCircleScaleAlignment) {
    /**
...
/**
 Controls the frame of reference for ``MHCircleStyleLayer/circleTranslation``.

 Values of this type are used in the ``MHCircleStyleLayer/circleTranslationAnchor``
 property.
 */
typedef NS_ENUM(NSUInteger, MHCircleTranslationAnchor) {
    /**
...
/**
 An ``MHCircleStyleLayer`` is a style layer that renders one or more filled
 circles on the map.
 ...
 ``MHCircleStyleLayer`` object, or they can be ``MHCircleStyleLayer``,
 ``MHCircleStyleLayer``, ``MHCircleStyleLayer``, or ``MHCircleStyleLayer``
 instances in an ``MHCircleStyleLayer`` or ``MHCircleStyleLayer`` object.
 ...
 */
MH_EXPORT
@interface MHCircleStyleLayer : MHVectorStyleLayer
...
*/
@property (nonatomic) MHTransition circleBlurTransition;
...
*/
@property (nonatomic) MHTransition circleColorTransition;
...
*/
@property (nonatomic) MHTransition circleOpacityTransition;
 ...
 * Constant `MHCirclePitchAlignment` values
...
*/
@property (nonatomic) MHTransition circleRadiusTransition;
 ...
 * Constant `MHCircleScaleAlignment` values
 * Any of the following constant string values:
...
*/
@property (nonatomic) MHTransition circleStrokeColorTransition;
...
*/
@property (nonatomic) MHTransition circleStrokeOpacityTransition;
...
*/
@property (nonatomic) MHTransition circleStrokeWidthTransition;
...
*/
@property (nonatomic) MHTransition circleTranslationTransition;
 ...
 * Constant `MHCircleTranslationAnchor` values
 * Any of the following constant string values:
...
/**
 ...
 ``MHCircleStyleLayer`` object and unwrapping its raw value.
 */
@interface NSValue (MHCircleStyleLayerAdditions)

// MARK: Working with Circle Style Layer Attribute Values

/**
 Creates a new value object containing the given `MHCirclePitchAlignment` enumeration.

 @param circlePitchAlignment The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHCirclePitchAlignment:(MHCirclePitchAlignment)circlePitchAlignment;

/**
 The ``MHCirclePitchAlignment`` enumeration representation of the value.
 */
@property (readonly) MHCirclePitchAlignment MHCirclePitchAlignmentValue;

/**
 Creates a new value object containing the given `MHCircleScaleAlignment` enumeration.

 @param circleScaleAlignment The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHCircleScaleAlignment:(MHCircleScaleAlignment)circleScaleAlignment;

/**
 The ``MHCircleScaleAlignment`` enumeration representation of the value.
 */
@property (readonly) MHCircleScaleAlignment MHCircleScaleAlignmentValue;

/**
 Creates a new value object containing the given `MHCircleTranslationAnchor` enumeration.

 @param circleTranslationAnchor The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithMHCircleTranslationAnchor:(MHCircleTranslationAnchor)circleTranslationAnchor;

/**
 The ``MHCircleTranslationAnchor`` enumeration representation of the value.
 */
@property (readonly) MHCircleTranslationAnchor MHCircleTranslationAnchorValue;
