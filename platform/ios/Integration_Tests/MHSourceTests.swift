...
class MHSourceTests: MHMapViewIntegrationTest {
    ...
    func testForRaisingExceptionsOnStaleStyleObjectsOnRemoveFromMapView() {
        ...
        let source = MHVectorTileSource(identifier: "trees", configurationURL: configURL)
        ...
        do {
            ...
            XCTAssertEqual(error.code, MHErrorCode.sourceCannotBeRemovedFromStyle.rawValue)
            expect.fulfill()
        }
