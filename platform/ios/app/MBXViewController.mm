...
#import "platform/ios/src/MHMapView_Private.h"
...
- (void)mapViewDidFinishRenderingFrame:(MHMapView *)mapView fullyRendered:(BOOL)fullyRendered frameEncodingTime:(double)frameEncodingTime frameRenderingTime:(double)frameRenderingTime {
