...
extension MHMapViewDelegateIntegrationTests: MHMapViewDelegate {
    ...
    func mapView(_: MHMapView, sourceDidChange _: MHSource) {}
    ...
    func mapView(_: MHMapView, shaderWillCompile _: Int, backend _: Int, defines _: String) {}
    func mapView(_: MHMapView, shaderDidCompile _: Int, backend _: Int, defines _: String) {}
    func mapView(_: MHMapView, shaderDidFailCompile _: Int, backend _: Int, defines _: String) {}

    func mapView(_: MHMapView, glyphsWillLoad _: [String], range _: NSRange) {}
    func mapView(_: MHMapView, glyphsDidLoad _: [String], range _: NSRange) {}
    func mapView(_: MHMapView, glyphsDidError _: [String], range _: NSRange) {}

    func mapView(_: MHMapView, tileDidTriggerAction _: MHTileOperation,
                 x _: Int,
                 y _: Int,
                 z _: Int,
                 wrap _: Int,
    ...
    func mapView(_: MHMapView, spriteWillLoad _: String, url _: String) {}
    func mapView(_: MHMapView, spriteDidLoad _: String, url _: String) {}
    func mapView(_: MHMapView, spriteDidError _: String, url _: String) {}
}
