...
@interface MHOrnamentTestData : NSObject

@property (nonatomic) MHOrnamentPosition position;
@property (nonatomic) CGPoint offset;
@property (nonatomic) CGPoint expectedOrigin;

@end

@implementation MHOrnamentTestData

+ (instancetype)createWithPosition:(MHOrnamentPosition)position offset:(CGPoint)offset expectedOrigin:(CGPoint)expectedOrigin {
    MHOrnamentTestData *data = [[MHOrnamentTestData alloc] init];
...
@interface MHMapViewLayoutTests : XCTestCase<MHMapViewDelegate>
...
@implementation MHMapViewLayoutTests
...
- (NSArray *)makeTestDataListWithView:(UIView *)view margin:(CGFloat)margin {
    ...
    return @[
             [MHOrnamentTestData createWithPosition:MHOrnamentPositionTopLeft
                                              offset:CGPointMake(margin, margin)
                                      expectedOrigin:CGPointMake(margin, margin)],
             [MHOrnamentTestData createWithPosition:MHOrnamentPositionTopRight
                                              offset:CGPointMake(margin, margin)
                                      expectedOrigin:CGPointMake(CGRectGetMaxX(self.mapView.bounds) - margin - CGRectGetWidth(view.frame), margin)],
             [MHOrnamentTestData createWithPosition:MHOrnamentPositionBottomLeft
                                              offset:CGPointMake(margin, margin)
             ...
             [MHOrnamentTestData createWithPosition:MHOrnamentPositionBottomRight
                                              offset:CGPointMake(margin, margin)
...
- (void)testCompassPlacement {
    ...
    for (MHOrnamentTestData *testData in testDataList) {
...
- (void)testScalebarSubviewPlacement {
    ...
    MHScaleBar *scaleBar = (MHScaleBar*)self.mapView.scaleBar;
    XCTAssertFalse(CGSizeEqualToSize(scaleBar.bounds.size, CGSizeZero));
