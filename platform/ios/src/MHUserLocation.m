...
- (BOOL)isEqual:(id)other {
    ...
    if (![other isKindOfClass:[MHUserLocation class]]) return NO;

    MHUserLocation *otherUserLocation = other;
...
- (BOOL)isUpdating
{
    return self.mapView.userTrackingMode != MHUserTrackingModeNone;
}
