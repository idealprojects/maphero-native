...
class MHMapViewImpl : public mbgl::MapObserver {
 public:
  static std::unique_ptr<MHMapViewImpl> Create(MHMapView*);

  MHMapViewImpl(MHMapView*);
  virtual ~MHMapViewImpl() = default;
  ...
  virtual MHBackendResource getObject() = 0;
 ...
 protected:
  ...
  __weak MHMapView* mapView = nullptr;
};
