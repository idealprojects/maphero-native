...
@implementation MHUserLocationHeadingBeamLayer
{
...
{
    CGFloat size = MHUserLocationAnnotationHaloSize;
...
- (CGImageRef)gradientImageWithTintColor:(CGColorRef)tintColor
{
    ...
    CGFloat haloRadius = MHUserLocationAnnotationHaloSize / 2.0;

    UIGraphicsBeginImageContextWithOptions(CGSizeMake(MHUserLocationAnnotationHaloSize, haloRadius), NO, 0);
...
- (CGPathRef)clippingMaskForAccuracy:(CGFloat)accuracy
{
    ...
    CGRect ovalRect = CGRectMake(0, 0, MHUserLocationAnnotationHaloSize, MHUserLocationAnnotationHaloSize);
    ...
    [ovalPath addArcWithCenter:CGPointMake(CGRectGetMidX(ovalRect), CGRectGetMidY(ovalRect))
                    ...
                    startAngle:MHRadiansFromDegrees(-180 + clippingDegrees)
                      endAngle:MHRadiansFromDegrees(-clippingDegrees)
                     clockwise:YES];
