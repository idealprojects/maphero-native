...
For more information, check out the [MapLibre Native for iOS repository](https://github.com/maplibre/maplibre-native) and the [full changelog](https://github.com/idealprojects/maphero-native/blob/main/platform/ios/platform/ios/CHANGELOG.md) online.
