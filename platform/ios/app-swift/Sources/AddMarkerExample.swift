...
struct AddMarkerSymbolExampleUIViewControllerRepresentable: UIViewControllerRepresentable {
    typealias UIViewControllerType = AddMarkerSymbolExampleUIKit

    func makeUIViewController(context _: Context) -> AddMarkerSymbolExampleUIKit {
        AddMarkerSymbolExampleUIKit()
    }

    func updateUIViewController(_: AddMarkerSymbolExampleUIKit, context _: Context) {}
}
