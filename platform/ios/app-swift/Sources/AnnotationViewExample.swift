...
struct AnnotationViewExampleUIViewControllerRepresentable: UIViewControllerRepresentable {
    typealias UIViewControllerType = AnnotationViewExample

    func makeUIViewController(context _: Context) -> AnnotationViewExample {
        AnnotationViewExample()
    }

    func updateUIViewController(_: AnnotationViewExample, context _: Context) {}
}
