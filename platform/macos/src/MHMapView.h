...
/**
 ...
 A collection of Mapbox-hosted styles is available through the ``MHStyle`` class.
 ...
 default ``MHMapView`` click gesture recognizer fails:
 ...
 */
MH_EXPORT IB_DESIGNABLE @interface MHMapView : NSView<MHStylable>
 ...
 */
- (nullable MHAnnotationImage *)dequeueReusableAnnotationImageWithIdentifier:
    (NSString *)identifier;
...
/**
 ...
 If the annotation is of type ``MHPointAnnotation`` and is offscreen, the map is
 ...
 */
- (void)deselectAnnotation:(nullable id<MHAnnotation>)annotation;
...
/**
 ...
 @return An array of objects conforming to the ``MHFeature`` protocol that
    represent features in the sources used by the current style.
 */
- (NSArray<id<MHFeature>> *)visibleFeaturesInRect:(NSRect)rect NS_SWIFT_NAME(visibleFeatures(in:));
