...
/**
 ...
 can use to receive messages from an ``MHMapView`` instance. Because many map
 operations require the ``MHMapView`` class to load data asynchronously, the map
 ...
 */
- (void)mapView:(MHMapView *)mapView cameraWillChangeAnimated:(BOOL)animated;
 ...
 */
- (void)mapViewCameraIsChanging:(MHMapView *)mapView;
 ...
 */
- (void)mapView:(MHMapView *)mapView cameraDidChangeAnimated:(BOOL)animated;
 ...
 */
- (nullable NSImage *)mapView:(MHMapView *)mapView didFailToLoadImage:(NSString *)imageName;
 ...
 */
- (NSColor *)mapView:(MHMapView *)mapView strokeColorForShapeAnnotation:(MHShape *)annotation;
 ...
 */
- (NSColor *)mapView:(MHMapView *)mapView fillColorForPolygonAnnotation:(MHPolygon *)annotation;
...
/**
 ...
 ``MHMapView/calloutViewController`` property instead.

 @param mapView The map view that is requesting a callout view controller.
 @param annotation The object representing the annotation.
 @return A view controller for the given annotation.
 */
- (nullable NSViewController *)mapView:(MHMapView *)mapView
    calloutViewControllerForAnnotation:(id<MHAnnotation>)annotation;
