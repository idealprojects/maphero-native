...
@interface MHMapView (IBAdditions)
...
// inspectables declared in MHMapView.h are always sorted before those in
// MHMapView+IBAdditions.h, due to ASCII sort order.
...
/** URL of the style currently displayed in the receiver.
    ...
    The URL may be a full HTTP or HTTPS URL, canonical URL, or a path to a local file
