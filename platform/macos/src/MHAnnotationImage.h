...
/**
 The ``MHAnnotationImage`` class is responsible for presenting point-based
 annotations visually on an ``MHMapView`` instance. Annotation image objects pair
 ...
 */
MH_EXPORT
@interface MHAnnotationImage : NSObject <NSSecureCoding>
 ...
 */
+ (instancetype)annotationImageWithImage:(NSImage *)image
