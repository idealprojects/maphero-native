package org.maphero.android.testapp.geometry;
...
import org.maphero.android.testapp.action.MapHeroMapAction;
import org.maphero.android.testapp.activity.BaseTest;
import org.maphero.android.testapp.activity.feature.QueryRenderedFeaturesBoxHighlightActivity;
...
public class LatLngBoundsTest extends BaseTest {
  ...
  public void testLatLngBounds() {
    ...
    validateTestSetup();
    MapHeroMapAction.invoke(maplibreMap, (uiController, maplibreMap) -> {
