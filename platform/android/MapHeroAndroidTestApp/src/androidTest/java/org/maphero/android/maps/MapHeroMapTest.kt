...
import org.maphero.android.exceptions.InvalidMarkerPositionException
import org.maphero.android.geometry.LatLng
import org.maphero.android.maps.MapHeroMap.InfoWindowAdapter
import org.maphero.android.maps.renderer.MapRenderer.RenderingRefreshMode
 ...
 *
 *
 * Methods executed on MapHeroMap are called from a ViewAction to ensure correct synchronisation
 * with the application UI-thread.
 *
 */
class MapHeroMapTest : EspressoTest() {
    //
    // InfoWindow
    //
    @Test
    ...
    fun testConcurrentInfoWindowEnabled() {
        validateTestSetup()
        onView(ViewMatchers.withId(R.id.mapView)).perform(MapHeroMapAction { uiController: UiController?, view: View? ->
    ...
    fun testAddEmptyPolyline() {
        validateTestSetup()
        onView(ViewMatchers.withId(R.id.mapView)).perform(MapHeroMapAction { _: UiController?, _: View? ->
    ...
    fun testGetAnnotations() {
        ...
        onView(ViewMatchers.withId(R.id.mapView)).perform(
            MapHeroMapAction { uiController: UiController?, view: View? -> TestCase.assertNotNull("Annotations should be non null", maplibreMap.annotations) }
        )
    }
    ...
    fun testGetMarkers() {
        validateTestSetup()
        onView(ViewMatchers.withId(R.id.mapView)).perform(
            MapHeroMapAction { uiController: UiController?, view: View? -> TestCase.assertNotNull("Markers should be non null", maplibreMap.markers) }
        )
    }
    ...
    fun testGetPolygons() {
        validateTestSetup()
        onView(ViewMatchers.withId(R.id.mapView)).perform(MapHeroMapAction { uiController: UiController?, view: View? -> TestCase.assertNotNull("Polygons should be non null", maplibreMap.polygons) }
        )
    }
    ...
    fun testGetPolylines() {
        validateTestSetup()
        onView(ViewMatchers.withId(R.id.mapView)).perform(MapHeroMapAction { uiController: UiController?, view: View? -> TestCase.assertNotNull("Polylines should be non null", maplibreMap.polylines) }
        )
    }
    ...
    fun testGetSelectedMarkers() {
        validateTestSetup()
        onView(ViewMatchers.withId(R.id.mapView)).perform(MapHeroMapAction { uiController: UiController?, view: View? -> TestCase.assertNotNull("Selected markers should be non null", maplibreMap.selectedMarkers) }
        )
    }
    ...
    inner class MapHeroMapAction internal constructor(private val invokeViewAction: InvokeViewAction) : ViewAction {
