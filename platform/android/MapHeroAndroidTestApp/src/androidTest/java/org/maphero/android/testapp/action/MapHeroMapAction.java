...
public class MapHeroMapAction implements ViewAction {

  private OnInvokeActionListener invokeViewAction;
  private MapHeroMap maplibreMap;

  public MapHeroMapAction(OnInvokeActionListener invokeViewAction, MapHeroMap maplibreMap) {
  ...
  public static void invoke(MapHeroMap maplibreMap, OnInvokeActionListener invokeViewAction) {
    onView(withId(android.R.id.content)).perform(new MapHeroMapAction(invokeViewAction, maplibreMap));
  }
