package org.maphero.android.testapp.activity.stability
...
import org.maphero.android.annotations.IconFactory
...
class UserMap : SupportMapFragment() {
    private lateinit var map: MapHeroMap
    ...
    companion object {
        ...
        // true -> use all bitmap drawables in `org.maphero.android.R.drawable.*`
        private const val USE_ALL_DRAWABLES = false
        private val ICONS = arrayListOf(
            org.maphero.android.R.drawable.maphero_info_icon_default,
            org.maphero.android.R.drawable.maphero_user_icon,
            org.maphero.android.R.drawable.maphero_marker_icon_default,
            org.maphero.android.R.drawable.maphero_compass_icon,
            org.maphero.android.R.drawable.maphero_user_puck_icon,
        )
        ...
        private fun randomLatLng(map: MapHeroMap): LatLng =
    ...
    private fun run() {
        if (USE_ALL_DRAWABLES) {
            bitmapDrawables =
                org.maphero.android.R.drawable::class.java.fields.map { field: Field ->
