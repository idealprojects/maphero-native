package org.maphero.android.testapp.activity.events
...
class ObserverActivity : AppCompatActivity(),
    ...
    private fun printActionJournal(map: MapHeroMap) {
        // configure using `MapHeroMapOptions.actionJournal*` methods
