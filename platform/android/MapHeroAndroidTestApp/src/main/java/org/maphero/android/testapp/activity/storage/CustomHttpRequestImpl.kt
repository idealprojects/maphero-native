...
import org.maphero.android.storage.FileSource.ResourceTransformCallback
import org.maphero.android.storage.Resource
...
class CustomHttpRequestImplActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mapView.getMapAsync(
            OnMapReadyCallback { maplibreMap: MapHeroMap ->
