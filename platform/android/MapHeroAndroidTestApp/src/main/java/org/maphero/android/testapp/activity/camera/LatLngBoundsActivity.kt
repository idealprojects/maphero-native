...
import org.maphero.android.style.layers.Property.ICON_ANCHOR_CENTER
...
import org.maphero.android.testapp.databinding.ActivityLatlngboundsBinding
        ...
        bottomSheetBehavior.addBottomSheetCallback(
            object : BottomSheetBehavior.BottomSheetCallback() {
                override fun onSlide(bottomSheet: View, slideOffset: Float) {
                    ...
                    mapHeroMap.getCameraForLatLngBounds(bounds, createPadding(bottomPadding))
                        ?.let { mapHeroMap.cameraPosition = it }
                }
