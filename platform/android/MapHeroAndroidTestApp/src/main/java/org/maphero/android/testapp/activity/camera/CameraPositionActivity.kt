...
class CameraPositionActivity : FragmentActivity(), OnMapReadyCallback, View.OnClickListener, OnMapLongClickListener {
    ...
    override fun onMapReady(map: MapHeroMap) {
        maplibreMap = map
    ...
    private class DialogClickListener(private val maplibreMap: MapHeroMap?, private val dialogContent: View) : DialogInterface.OnClickListener {
