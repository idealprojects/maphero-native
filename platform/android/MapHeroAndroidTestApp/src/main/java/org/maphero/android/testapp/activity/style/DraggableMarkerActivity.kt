...
import org.maphero.android.testapp.databinding.ActivityDraggableMarkerBinding
...
private fun MapHeroMap.queryRenderedSymbols(latLng: LatLng, layerId: String): List<Feature> {
