...
import org.maphero.android.testapp.activity.stability.LongRunningActivity.Companion.printStats
import org.maphero.android.testapp.styles.TestStyles
import org.maphero.android.testapp.utils.GeoParseUtil
...
import org.maplibre.navigation.android.navigation.v5.navigation.MapHeroNavigation
import org.maplibre.navigation.android.navigation.v5.navigation.MapHeroNavigationOptions
...
class NavigationMap : SupportMapFragment(), ProgressChangeListener, MilestoneEventListener {
    ...
    private lateinit var navigation: MapHeroNavigation
    ...
    private fun run() {
        lifecycleScope.launch {
            ...
            navigation = MapHeroNavigation(requireContext(), MapHeroNavigationOptions
                .builder()
                .snapToRoute(true)
                .build()
            ).apply {
    ...
    private fun getRoute(): DirectionsRoute? {
        ...
        val routeString: String? = when (ROUTE_PROVIDER) {
            ...
            RouteProvider.OSRM -> {
                ...
                val request = Request
                    .Builder()
                    .header("User-Agent", "MapHero Android")
