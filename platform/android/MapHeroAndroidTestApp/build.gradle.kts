...
android {
    ...
    defaultConfig {
        applicationId = "org.maphero.android.testapp"
        minSdk = 23
        targetSdk = 33
        versionCode = 14
        testInstrumentationRunner = "org.maphero.android.InstrumentationRunner"
    ...
    namespace = "org.maphero.android.testapp"
...
dependencies {
    implementation(project(":MapHeroAndroid"))
