...
class PolygonContainer implements Polygons {
  ...
  @Override
  public Polygon addBy(@NonNull PolygonOptions polygonOptions, @NonNull MapHeroMap maplibreMap) {
    Polygon polygon = polygonOptions.getPolygon();
    long id = nativeMap != null ? nativeMap.addPolygon(polygon) : 0;
    polygon.setId(id);
    polygon.setMapHeroMap(maplibreMap);
  ...
  @NonNull
  @Override
  public List<Polygon> addBy(@NonNull List<PolygonOptions> polygonOptionsList, @NonNull MapHeroMap maplibreMap) {
