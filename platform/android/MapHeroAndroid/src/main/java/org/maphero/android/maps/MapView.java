 ...
 * </p>
 * <p>
 * Use of {@code MapView} requires a MapHero API access token.
 * Obtain an access token on the <a href="https://www.mapbox.com/studio/account/tokens/">MapHero account page</a>.
 * </p>
...
public class MapView extends FrameLayout implements NativeMapView.ViewCallback {
  ...
  MapHeroMapOptions maplibreMapOptions;
  ...
  private void initializeMap() {
    ...
    maplibreMap = new MapHeroMap(nativeMapView, transform, uiSettings, proj, registerTouchListener, cameraDispatcher,
   ...
   * {@link MapHero#getInstance(Context, String, WellKnownTileServer)}
  ...
  private void initializeDrawingSurface(MapHeroMapOptions options) {
  ...
  void setMapHeroMap(MapHeroMap maplibreMap) {
  ...
  private static class AttributionClickListener implements OnClickListener {
    ...
    private AttributionClickListener(@NonNull Context context, @NonNull MapHeroMap maplibreMap) {
