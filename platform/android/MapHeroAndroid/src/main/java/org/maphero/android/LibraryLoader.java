...
import org.maphero.android.utils.PlatformUtils;
...
public abstract class LibraryLoader {
  ...
  private static final LibraryLoader DEFAULT = MapHero.getModuleProvider()
  ...
  /**
   * Loads "libmaphero.so" native shared library.
   * <p>
