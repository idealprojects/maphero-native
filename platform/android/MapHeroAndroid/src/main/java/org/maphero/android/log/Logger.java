package org.maphero.android.log;
...
/**
 * Logger for the MapHero Maps SDK for Android
 * <p>
...
public final class Logger {
  ...
  /**
   * Log level indicates which logs are allowed to be emitted by the MapHero Maps SDK for Android.
   */
