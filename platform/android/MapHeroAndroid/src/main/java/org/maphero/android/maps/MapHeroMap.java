...
public final class MapHeroMap {
  ...
  private static final String TAG = "Mbgl-MapHeroMap";
   ...
   * @see MapHeroMap#setTileLodMinRadius(double)
   */
   ...
   * @see MapHeroMap#setTileLodScale(double)
   */
   ...
   * @see MapHeroMap#setTileLodPitchThreshold(double)
   */
   ...
   * TileLodZoomShift. {@link MapHeroMapOptions#pixelRatio(float)}
   */
   ...
   * @see MapHeroMap#setTileLodZoomShift(double)
   */
