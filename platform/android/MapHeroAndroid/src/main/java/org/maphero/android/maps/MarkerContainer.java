...
class MarkerContainer implements Markers {
  ...
  @Override
  public Marker addBy(@NonNull BaseMarkerOptions markerOptions, @NonNull MapHeroMap maplibreMap) {
    Marker marker = prepareMarker(markerOptions);
    long id = nativeMapView != null ? nativeMapView.addMarker(marker) : 0;
    marker.setMapHeroMap(maplibreMap);
    marker.setId(id);
    ...
    if (nativeMapView != null && count > 0) {
      ...
      if (markers.size() > 0) {
        ...
        for (int i = 0; i < ids.length; i++) {
          ...
          createdMarker.setMapHeroMap(maplibreMap);
  ...
  @Override
  public void update(@NonNull Marker updatedMarker, @NonNull MapHeroMap maplibreMap) {
  ...
  private void ensureIconLoaded(Marker marker, @NonNull MapHeroMap maplibreMap) {
