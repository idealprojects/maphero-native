...
public class Transform implements MapView.OnCameraDidChangeListener {
  ...
  void initialise(@NonNull MapHeroMap maplibreMap, @NonNull MapHeroMapOptions options) {
   ...
   */
  @UiThread
  public void moveCamera(@NonNull MapHeroMap maplibreMap, CameraUpdate update,
  ...
  @UiThread
  void easeCamera(@NonNull MapHeroMap maplibreMap, CameraUpdate update, int durationMs,
   ...
   */
  @UiThread
  public void animateCamera(@NonNull MapHeroMap maplibreMap, CameraUpdate update, int durationMs,
                                  @Nullable final MapHeroMap.CancelableCallback callback) {
    CameraPosition cameraPosition = update.getCameraPosition(maplibreMap);
    if (isValidCameraPosition(cameraPosition)) {
      cancelTransitions();
