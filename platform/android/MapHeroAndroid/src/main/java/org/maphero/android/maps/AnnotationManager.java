...
class AnnotationManager {
  ...
  @NonNull
  AnnotationManager bind(MapHeroMap maplibreMap) {
  ...
  Marker addMarker(@NonNull BaseMarkerOptions markerOptions, @NonNull MapHeroMap maplibreMap) {
  ...
  List<Marker> addMarkers(@NonNull List<? extends BaseMarkerOptions> markerOptionsList,
                          @NonNull MapHeroMap maplibreMap) {
    return markers.addBy(markerOptionsList, maplibreMap);
  }

  void updateMarker(@NonNull Marker updatedMarker, @NonNull MapHeroMap maplibreMap) {
  ...
  Polygon addPolygon(@NonNull PolygonOptions polygonOptions, @NonNull MapHeroMap maplibreMap) {
    return polygons.addBy(polygonOptions, maplibreMap);
  }

  List<Polygon> addPolygons(@NonNull List<PolygonOptions> polygonOptionsList, @NonNull MapHeroMap maplibreMap) {
  ...
  Polyline addPolyline(@NonNull PolylineOptions polylineOptions, @NonNull MapHeroMap maplibreMap) {
    return polylines.addBy(polylineOptions, maplibreMap);
  }

  List<Polyline> addPolylines(@NonNull List<PolylineOptions> polylineOptionsList, @NonNull MapHeroMap maplibreMap) {
  ...
  void adjustTopOffsetPixels(@NonNull MapHeroMap maplibreMap) {
    int count = annotationsArray.size();
    for (int i = 0; i < count; i++) {
  ...
  private static class MarkerHitResolver {
    ...
    MarkerHitResolver(@NonNull MapHeroMap maplibreMap) {
