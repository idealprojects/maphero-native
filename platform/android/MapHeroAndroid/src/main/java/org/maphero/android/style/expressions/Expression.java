package org.maphero.android.style.expressions;
...
import static org.maphero.android.utils.ColorUtils.colorToRgbaArray;
 ...
 * The set of expression operators provided by MapHero GL includes:
 * <ul>
 * <li>Element</li>
...
public class Expression {
   ...
   * or right-to-left scripts if the the mapbox-gl-rtl-text plugin is not in use in MapHero GL JS).
   * <p>
   * Example usage:
   * </p>
   * <pre>
