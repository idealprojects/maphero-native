 ...
 */
interface Markers {
  Marker addBy(@NonNull BaseMarkerOptions markerOptions, @NonNull MapHeroMap maplibreMap);

  List<Marker> addBy(@NonNull List<? extends BaseMarkerOptions> markerOptionsList, @NonNull MapHeroMap maplibreMap);

  void update(@NonNull Marker updatedMarker, @NonNull MapHeroMap maplibreMap);
