...
import static org.maphero.android.location.LocationComponentConstants.INSTANT_LOCATION_TRANSITION_THRESHOLD;
...
public final class Utils {
  ...
  static float calculateZoomLevelRadius(@NonNull MapHeroMap maplibreMap, @Nullable Location location) {
    if (location == null) {
      return 0;
    }
