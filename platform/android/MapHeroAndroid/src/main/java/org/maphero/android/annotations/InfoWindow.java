...
public class InfoWindow {
  ...
  private WeakReference<MapHeroMap> maplibreMap;
  ...
  InfoWindow(MapView mapView, int layoutResId, MapHeroMap maplibreMap) {
  ...
  InfoWindow(@NonNull View view, MapHeroMap maplibreMap) {
    initialize(view, maplibreMap);
  }

  private void initialize(@NonNull View view, MapHeroMap maplibreMap) {
    ...
    view.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        MapHeroMap maplibreMap = InfoWindow.this.maplibreMap.get();
        if (maplibreMap != null) {
          MapHeroMap.OnInfoWindowClickListener onInfoWindowClickListener = maplibreMap.getOnInfoWindowClickListener();
    ...
    view.setOnLongClickListener(new View.OnLongClickListener() {
      ...
      public boolean onLongClick(View v) {
        MapHeroMap maplibreMap = InfoWindow.this.maplibreMap.get();
        if (maplibreMap != null) {
          MapHeroMap.OnInfoWindowLongClickListener listener = maplibreMap.getOnInfoWindowLongClickListener();
          if (listener != null) {
  ...
  private void closeInfoWindow() {
    MapHeroMap mapbox = maplibreMap.get();
  ...
  InfoWindow open(@NonNull MapView mapView, Marker boundMarker, @NonNull LatLng position, int offsetX, int offsetY) {
    ...
    MapHeroMap maplibreMap = this.maplibreMap.get();
  ...
  InfoWindow close() {
    ...
    if (isVisible && maplibreMap != null) {
      ...
      MapHeroMap.OnInfoWindowCloseListener listener = maplibreMap.getOnInfoWindowCloseListener();
      if (listener != null) {
   ...
   */
  void adaptDefaultMarker(@NonNull Marker overlayItem, MapHeroMap maplibreMap, @NonNull MapView mapView) {
    View view = this.view.get();
    if (view == null) {
