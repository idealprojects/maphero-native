...
public class MapHeroMapOptions implements Parcelable {
  ...
  @VisibleForTesting
  static MapHeroMapOptions createFromAttributes(@NonNull MapHeroMapOptions maplibreMapOptions,
    ...
    try {
      ...
      // deprecated
      maplibreMapOptions.apiBaseUrl(typedArray.getString(R.styleable.MAPHERO_MapView_MAPHERO_apiBaseUrl));
      ...
      maplibreMapOptions.maxZoomPreference(typedArray.getFloat(R.styleable.MAPHERO_MapView_MAPHERO_cameraZoomMax,
        MapHeroConstants.MAXIMUM_ZOOM));
      maplibreMapOptions.minZoomPreference(typedArray.getFloat(R.styleable.MAPHERO_MapView_MAPHERO_cameraZoomMin,
        MapHeroConstants.MINIMUM_ZOOM));
      maplibreMapOptions.maxPitchPreference(typedArray.getFloat(R.styleable.MAPHERO_MapView_MAPHERO_cameraPitchMax,
        MapHeroConstants.MAXIMUM_PITCH));
      maplibreMapOptions.minPitchPreference(typedArray.getFloat(R.styleable.MAPHERO_MapView_MAPHERO_cameraPitchMin,
        MapHeroConstants.MINIMUM_PITCH));

      maplibreMapOptions.compassEnabled(typedArray.getBoolean(R.styleable.MAPHERO_MapView_MAPHERO_uiCompass, true));
      maplibreMapOptions.compassGravity(typedArray.getInt(R.styleable.MAPHERO_MapView_MAPHERO_uiCompassGravity,
      ...
      maplibreMapOptions.logoEnabled(typedArray.getBoolean(R.styleable.MAPHERO_MapView_MAPHERO_uiLogo, true));
      maplibreMapOptions.logoGravity(typedArray.getInt(R.styleable.MAPHERO_MapView_MAPHERO_uiLogoGravity,
      ...
      maplibreMapOptions.actionJournalEnabled(
        typedArray.getBoolean(R.styleable.MAPHERO_MapView_MAPHERO_actionJournalEnabled, false)
      );
      maplibreMapOptions.actionJournalLogFileSize(
        typedArray.getInteger(R.styleable.MAPHERO_MapView_MAPHERO_actionJournalLogFileSize, 1024 * 1024)
      );
      maplibreMapOptions.actionJournalLogFileCount(
        typedArray.getInteger(R.styleable.MAPHERO_MapView_MAPHERO_actionJournalLogFileCount, 5)
      );
      maplibreMapOptions.actionJournalRenderingReportInterval(
              typedArray.getInteger(R.styleable.MAPHERO_MapView_MAPHERO_actionJournalRenderingReportInterval, 60)
      );
    } finally {
      typedArray.recycle();
    }
   ...
   */
  @NonNull
  public MapHeroMapOptions actionJournalEnabled(boolean actionJournalEnabled) {
   ...
   */
  @NonNull
  public MapHeroMapOptions actionJournalPath(@NonNull String actionJournalPath) {
   ...
   */
  @NonNull
  public MapHeroMapOptions actionJournalLogFileSize(long actionJournalLogFileSize) {
   ...
   */
  @NonNull
  public MapHeroMapOptions actionJournalLogFileCount(long actionJournalLogFileCount) {
   ...
   */
  @NonNull
  public MapHeroMapOptions actionJournalRenderingReportInterval(int actionJournalRenderingReportInterval) {
