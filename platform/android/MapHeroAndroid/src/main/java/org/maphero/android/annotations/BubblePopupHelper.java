...
class BubblePopupHelper {
  ...
  static PopupWindow create(@NonNull Context context, @NonNull BubbleLayout bubbleLayout) {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
      drawable = context.getDrawable(R.drawable.maphero_popup_window_transparent);
    } else {
      drawable = context.getResources().getDrawable(R.drawable.maphero_popup_window_transparent);
    }
