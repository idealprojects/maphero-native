...
public class Marker extends Annotation {
   ...
   *
   * @param maplibreMap The hosting MapHeroMap.
   * @param mapView   The hosting map view.
   * @return The info window that was shown.
   */
  @Nullable
  public InfoWindow showInfoWindow(@NonNull MapHeroMap maplibreMap, @NonNull MapView mapView) {
    setMapHeroMap(maplibreMap);
    setMapView(mapView);
