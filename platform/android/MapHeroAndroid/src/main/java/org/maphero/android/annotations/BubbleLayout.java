 ...
 *   MapHero Annotation Plugin</a> can reference the image ID.
 */
@Deprecated
public class BubbleLayout extends LinearLayout {
  ...
  public BubbleLayout(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.MAPHERO_BubbleLayout);
    @ArrowDirection.Value
    int location = a.getInt(R.styleable.MAPHERO_BubbleLayout_MAPHERO_bl_arrowDirection,
      ArrowDirection.LEFT);
    arrowDirection = new ArrowDirection(location);
    arrowWidth = a.getDimension(R.styleable.MAPHERO_BubbleLayout_MAPHERO_bl_arrowWidth,
      convertDpToPixel(8, context));
    arrowHeight = a.getDimension(R.styleable.MAPHERO_BubbleLayout_MAPHERO_bl_arrowHeight,
      convertDpToPixel(8, context));
    arrowPosition = a.getDimension(R.styleable.MAPHERO_BubbleLayout_MAPHERO_bl_arrowPosition,
      convertDpToPixel(12, context));
    cornersRadius = a.getDimension(R.styleable.MAPHERO_BubbleLayout_MAPHERO_bl_cornersRadius, 0);
    bubbleColor = a.getColor(R.styleable.MAPHERO_BubbleLayout_MAPHERO_bl_bubbleColor, Color.WHITE);
    strokeWidth =
      a.getDimension(R.styleable.MAPHERO_BubbleLayout_MAPHERO_bl_strokeWidth, DEFAULT_STROKE_WIDTH);
    strokeColor = a.getColor(R.styleable.MAPHERO_BubbleLayout_MAPHERO_bl_strokeColor, Color.GRAY);
