...
public class LocationComponentOptions implements Parcelable {
  ...
  public static LocationComponentOptions createFromAttributes(@NonNull Context context,
    ...
    TypedArray typedArray = context.obtainStyledAttributes(
      styleRes, R.styleable.MAPHERO_LocationComponent);
    ...
    builder.foregroundDrawable(typedArray.getResourceId(
      R.styleable.MAPHERO_LocationComponent_MAPHERO_foregroundDrawable, -1));
    if (typedArray.hasValue(R.styleable.MAPHERO_LocationComponent_MAPHERO_foregroundTintColor)) {
      builder.foregroundTintColor(typedArray.getColor(
        R.styleable.MAPHERO_LocationComponent_MAPHERO_foregroundTintColor, -1));
    }
    builder.backgroundDrawable(typedArray.getResourceId(
      R.styleable.MAPHERO_LocationComponent_MAPHERO_backgroundDrawable, -1));
    if (typedArray.hasValue(R.styleable.MAPHERO_LocationComponent_MAPHERO_backgroundTintColor)) {
      builder.backgroundTintColor(typedArray.getColor(
        R.styleable.MAPHERO_LocationComponent_MAPHERO_backgroundTintColor, -1));
    }
    builder.foregroundDrawableStale(typedArray.getResourceId(
      R.styleable.MAPHERO_LocationComponent_MAPHERO_foregroundDrawableStale, -1));
    if (typedArray.hasValue(R.styleable.MAPHERO_LocationComponent_MAPHERO_foregroundStaleTintColor)) {
      builder.foregroundStaleTintColor(typedArray.getColor(
        R.styleable.MAPHERO_LocationComponent_MAPHERO_foregroundStaleTintColor, -1));
    }
    builder.backgroundDrawableStale(typedArray.getResourceId(
      R.styleable.MAPHERO_LocationComponent_MAPHERO_backgroundDrawableStale, -1));
    if (typedArray.hasValue(R.styleable.MAPHERO_LocationComponent_MAPHERO_backgroundStaleTintColor)) {
      builder.backgroundStaleTintColor(typedArray.getColor(
        R.styleable.MAPHERO_LocationComponent_MAPHERO_backgroundStaleTintColor, -1));
    }
    builder.bearingDrawable(typedArray.getResourceId(
      R.styleable.MAPHERO_LocationComponent_MAPHERO_bearingDrawable, -1));
    if (typedArray.hasValue(R.styleable.MAPHERO_LocationComponent_MAPHERO_bearingTintColor)) {
      builder.bearingTintColor(typedArray.getColor(
        R.styleable.MAPHERO_LocationComponent_MAPHERO_bearingTintColor, -1));
    }
    if (typedArray.hasValue(R.styleable.MAPHERO_LocationComponent_MAPHERO_enableStaleState)) {
      builder.enableStaleState(typedArray.getBoolean(
        R.styleable.MAPHERO_LocationComponent_MAPHERO_enableStaleState, true));
    }
    if (typedArray.hasValue(R.styleable.MAPHERO_LocationComponent_MAPHERO_staleStateTimeout)) {
      builder.staleStateTimeout(typedArray.getInteger(
        R.styleable.MAPHERO_LocationComponent_MAPHERO_staleStateTimeout, (int) STALE_STATE_DELAY_MS));
    }
    builder.gpsDrawable(typedArray.getResourceId(
      R.styleable.MAPHERO_LocationComponent_MAPHERO_gpsDrawable, -1));
    float elevation = typedArray.getDimension(
      R.styleable.MAPHERO_LocationComponent_MAPHERO_elevation, 0);
    builder.accuracyColor(typedArray.getColor(
      R.styleable.MAPHERO_LocationComponent_MAPHERO_accuracyColor, -1));
    builder.accuracyAlpha(typedArray.getFloat(
      R.styleable.MAPHERO_LocationComponent_MAPHERO_accuracyAlpha, ACCURACY_ALPHA_DEFAULT));
    builder.elevation(elevation);

    builder.trackingGesturesManagement(typedArray.getBoolean(
      R.styleable.MAPHERO_LocationComponent_MAPHERO_trackingGesturesManagement, false));
    builder.trackingInitialMoveThreshold(typedArray.getDimension(
      R.styleable.MAPHERO_LocationComponent_MAPHERO_trackingInitialMoveThreshold,
      context.getResources().getDimension(R.dimen.MAPHERO_locationComponentTrackingInitialMoveThreshold)));
    builder.trackingMultiFingerMoveThreshold(typedArray.getDimension(
      R.styleable.MAPHERO_LocationComponent_MAPHERO_trackingMultiFingerMoveThreshold,
      context.getResources().getDimension(R.dimen.MAPHERO_locationComponentTrackingMultiFingerMoveThreshold)));

    builder.padding(new int[] {
      typedArray.getInt(R.styleable.MAPHERO_LocationComponent_MAPHERO_iconPaddingLeft, 0),
      typedArray.getInt(R.styleable.MAPHERO_LocationComponent_MAPHERO_iconPaddingTop, 0),
      typedArray.getInt(R.styleable.MAPHERO_LocationComponent_MAPHERO_iconPaddingRight, 0),
      typedArray.getInt(R.styleable.MAPHERO_LocationComponent_MAPHERO_iconPaddingBottom, 0),
    });

    builder.layerAbove(
      typedArray.getString(R.styleable.MAPHERO_LocationComponent_MAPHERO_layer_above));

    builder.layerBelow(
      typedArray.getString(R.styleable.MAPHERO_LocationComponent_MAPHERO_layer_below));

    float minScale = typedArray.getFloat(
      R.styleable.MAPHERO_LocationComponent_MAPHERO_minZoomIconScale, MIN_ZOOM_ICON_SCALE_DEFAULT);
    float maxScale = typedArray.getFloat(
      R.styleable.MAPHERO_LocationComponent_MAPHERO_maxZoomIconScale, MAX_ZOOM_ICON_SCALE_DEFAULT);
    ...
    float trackingAnimationDurationMultiplier = typedArray.getFloat(
      R.styleable.MAPHERO_LocationComponent_MAPHERO_trackingAnimationDurationMultiplier,
    ...
    builder.compassAnimationEnabled = typedArray.getBoolean(
      R.styleable.MAPHERO_LocationComponent_MAPHERO_compassAnimationEnabled, true
    );

    builder.accuracyAnimationEnabled = typedArray.getBoolean(
      R.styleable.MAPHERO_LocationComponent_MAPHERO_accuracyAnimationEnabled, true
    );

    builder.pulseEnabled = typedArray.getBoolean(
      R.styleable.MAPHERO_LocationComponent_MAPHERO_pulsingLocationCircleEnabled, false
    );

    builder.pulseFadeEnabled = typedArray.getBoolean(
      R.styleable.MAPHERO_LocationComponent_MAPHERO_pulsingLocationCircleFadeEnabled, true
    );

    if (typedArray.hasValue(R.styleable.MAPHERO_LocationComponent_MAPHERO_pulsingLocationCircleColor)) {
      builder.pulseColor(typedArray.getColor(
        R.styleable.MAPHERO_LocationComponent_MAPHERO_pulsingLocationCircleColor,
        -1));
    }

    builder.pulseSingleDuration = typedArray.getFloat(
      R.styleable.MAPHERO_LocationComponent_MAPHERO_pulsingLocationCircleDuration, CIRCLE_PULSING_DURATION_DEFAULT_MS
    );

    builder.pulseMaxRadius = typedArray.getFloat(
      R.styleable.MAPHERO_LocationComponent_MAPHERO_pulsingLocationCircleRadius, CIRCLE_PULSING_MAX_RADIUS_DEFAULT
    );

    builder.pulseAlpha = typedArray.getFloat(
      R.styleable.MAPHERO_LocationComponent_MAPHERO_pulsingLocationCircleAlpha, CIRCLE_PULSING_ALPHA_DEFAULT);
  ...
  public static Builder builder(@NonNull Context context) {
    return LocationComponentOptions.createFromAttributes(context,
      R.style.MAPHERO_LocationComponent).toBuilder();
  }
   ...
   * component, will use this image in place of the provided or default MAPHERO_foregroundDrawableStale.
   * <p>
   ...
   * String image name, identical to one used in
   * the first parameter of {@link org.maphero.android.maps.Style.Builder#addImage(String, Bitmap)}, the
   * component, will used this image in place of the provided or default MAPHERO_foregroundDrawableStale.
   * <p>
   * A maki-icon name (example: "circle-15") may also be provided.  These are images that can be loaded
   * with certain styles.  Note, this will fail if the provided icon name is not provided by the loaded map style.
   * </p>
   ...
   * String image name, identical to one used in
   * the first parameter of {@link org.maphero.android.maps.Style.Builder#addImage(String, Bitmap)}, the
   * component, will used this image in place of the provided or default MAPHERO_gpsDrawable.
   * <p>
   * A maki-icon name (example: "circle-15") may also be provided.  These are images that can be loaded
   * with certain styles.  Note, this will fail if the provided icon name is not provided by the loaded map style.
   * </p>
   ...
   * String image name, identical to one used in
   * the first parameter of {@link org.maphero.android.maps.Style.Builder#addImage(String, Bitmap)}, the
   * component, will used this image in place of the provided or default MAPHERO_foregroundDrawable.
   * <p>
   * A maki-icon name (example: "circle-15") may also be provided.  These are images that can be loaded
   * with certain styles.  Note, this will fail if the provided icon name is not provided by the loaded map style.
   * </p>
   ...
   * String image name, identical to one used in
   * the first parameter of {@link org.maphero.android.maps.Style.Builder#addImage(String, Bitmap)}, the
   * component, will used this image in place of the provided or default MAPHERO_backgroundDrawable.
   * <p>
   * A maki-icon name (example: "circle-15") may also be provided.  These are images that can be loaded
   * with certain styles.  Note, this will fail if the provided icon name is not provided by the loaded map style.
   * </p>
   ...
   * String image name, identical to one used in
   * the first parameter of {@link org.maphero.android.maps.Style.Builder#addImage(String, Bitmap)}, the
   * component, will used this image in place of the provided or default MAPHERO_bearingDrawable.
   * <p>
   * A maki-icon name (example: "circle-15") may also be provided.  These are images that can be loaded
   * with certain styles.  Note, this will fail if the provided icon name is not provided by the loaded map style.
   * </p>
   ...
   * {@link MapHeroMap#setGesturesManager(AndroidGesturesManager, boolean, boolean)}.
   *
  ...
  public static class Builder {
     ...
     * the first parameter of {@link org.maphero.android.maps.Style.Builder#addImage(String, Bitmap)}, the
     * component, will used this image in place of the provided or default MAPHERO_backgroundDrawableStale.
     * <p>
     * A maki-icon name (example: "circle-15") may also be provided.  These are images that can be loaded
     * with certain styles.  Note, this will fail if the provided icon name is not provided by the loaded map style.
     * </p>
     ...
     * @deprecated Use
     * {@link org.maphero.android.camera.CameraPosition.Builder#padding(double, double, double, double)} or
