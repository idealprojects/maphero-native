...
import org.maphero.android.exceptions.CalledFromWorkerThreadException;
import org.maphero.android.geometry.LatLng;
import org.maphero.android.geometry.LatLngBounds;
import org.maphero.android.geometry.ProjectedMeters;
...
final class NativeMapView implements NativeMap {
  ...
  private MapHeroMap.SnapshotReadyCallback snapshotReadyCallback;
  ...
  public NativeMapView(@NonNull final Context context, final MapHeroMapOptions options,
                       final ViewCallback viewCallback, final StateCallback stateCallback,
                       final MapRenderer mapRenderer) {
  ...
  @Override
  public void addSnapshotCallback(@NonNull MapHeroMap.SnapshotReadyCallback callback) {
  ...
  @Override
  public void setOnFpsChangedListener(@Nullable final MapHeroMap.OnFpsChangedListener listener) {
    ...
    mapRenderer.queueEvent(new Runnable() {
      ...
      public void run() {
        if (listener != null) {
          mapRenderer.setOnFpsChangedListener(new MapHeroMap.OnFpsChangedListener() {
            @Override
