...
import org.maphero.android.BuildConfig;
...
import static org.maphero.android.module.http.HttpRequestUtil.toHumanReadableAscii;
...
public class HttpRequestImpl implements HttpRequest {
  ...
  private static final String userAgentString = toHumanReadableAscii(
    String.format("%s %s (%s) Android/%s (%s)",
      ...
      BuildConfig.MAPHERO_VERSION_STRING,
