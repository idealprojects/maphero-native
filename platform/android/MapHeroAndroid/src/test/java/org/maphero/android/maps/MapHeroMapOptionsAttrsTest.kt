...
class MapHeroMapOptionsAttrsTest : BaseTest() {

    @RelaxedMockK
    private lateinit var options: MapHeroMapOptions
    ...
    fun enabledLocalIdeographFontFamily() {
        ...
        val options = MapHeroMapOptions.createFromAttributes(options, context, typedArray)
