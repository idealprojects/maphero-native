...
class MapHeroFusedLocationEngineImplTest : BaseTest() {
    @Mock
    private val locationManagerMock: LocationManager? = null
    private var engine: LocationEngine? = null
    private var maplibreFusedLocationEngineImpl: MapHeroFusedLocationEngineImpl? = null
    @Before
    fun setUp() {
        val context = mock(Context::class.java)
        `when`(context.getSystemService(Context.LOCATION_SERVICE)).thenReturn(locationManagerMock)
        maplibreFusedLocationEngineImpl = MapHeroFusedLocationEngineImpl(context)
