...
import org.maphero.android.MapHeroInjector.clear
import org.maphero.android.MapHeroInjector.inject
import org.maphero.android.exceptions.MapHeroConfigurationException
import org.maphero.android.maps.MapView
import org.maphero.android.utils.ConfigUtils.Companion.getMockedOptions
import org.mockito.ArgumentMatchers
import org.mockito.Mockito
import java.io.File

class MapHeroTest : BaseTest() {
    ...
    Using MapView requires calling MapHero.getInstance(Context context, String apiKey, WellKnownTileServer wellKnownTileServer) before inflating or creating the view.
    """.trimIndent())
        MapView(context!!)
    }
