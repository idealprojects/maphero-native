...
class MapHeroMapTest : BaseTest() {
    ...
    fun testEaseCamera() {
        ...
        verify { transform.easeCamera(maplibreMap, update, MapHeroConstants.ANIMATION_DURATION, true, callback) }
        verify { developerAnimationListener.onDeveloperAnimationStarted() }
    }
    ...
    fun testAnimateCamera() {
        ...
        verify { transform.animateCamera(maplibreMap, update, MapHeroConstants.ANIMATION_DURATION, callback) }
        verify { developerAnimationListener.onDeveloperAnimationStarted() }
    }
