...
dependencies {
    lintChecks(project(":MapHeroAndroidLint"))
...
dokka {
    moduleName.set("MapHero Native Android")
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField(
            "String",
            "MAPHERO_VERSION_STRING",
            "\"MapHero Android/${project.extra["versionName"]}\""
        )
    ...
    productFlavors {
        create("opengl") {
            ...
            externalNativeBuild {
                cmake {
                    arguments("-DMH_WITH_OPENGL=ON", "-DMH_WITH_VULKAN=OFF")
                }
            }
        }
        create("vulkan") {
            ...
            externalNativeBuild {
                cmake {
                    arguments("-DMH_WITH_OPENGL=OFF", "-DMH_WITH_VULKAN=ON")
                }
            }
        }
    }
