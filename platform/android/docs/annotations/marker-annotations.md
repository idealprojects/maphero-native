...
`org.maphero.android.annotations`, it has the following subclasses:
...
3. In `JsonApiActivity` we add a new variable for `MapHeroMap`.
   It is used to add annotations to the map instance.
  ```kotlin
  --8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/annotation/JsonApiActivity.kt:top"
  ```

4. Call `mapview.getMapSync()` in order to get a `MapHeroMap` object.
  ...
  ```kotlin
  --8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/annotation/JsonApiActivity.kt:mapAsync"
  ```
...
5. Define a function `getEarthQuakeDataFromUSGS()` to fetch GeoJSON data from a public API.
  ...
  ```kotlin
  --8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/annotation/JsonApiActivity.kt:getEarthquakes"
  ```
...
6. Now it is time to add markers into the map.
  ...
  ```kotlin
  --8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/annotation/JsonApiActivity.kt:addMarkers"
  ```
...
[Marker]: https://maplibre.org/maplibre-native/android/api/-map-libre%20-native%20-android/org.maphero.android.annotations/-marker/index.html
[provided image]: https://github.com/maplibre/maplibre-native/blob/main/platform/android/MapHeroAndroid/src/main/res/drawable-xxxhdpi/MAPHERO_marker_icon_default.png
[Polyline]: https://maplibre.org/maplibre-native/android/api/-map-libre%20-native%20-android/org.maphero.android.annotations/-polyline/index.html
[Polygon]: https://maplibre.org/maplibre-native/android/api/-map-libre%20-native%20-android/org.maphero.android.annotations/-polygon/index.html
[marker image]: https://raw.githubusercontent.com/maplibre/maplibre-native/main/test/fixtures/sprites/default_marker.png
[IconFactory]: https://maplibre.org/maplibre-native/android/api/-map-libre%20-native%20-android/org.maphero.android.annotations/-icon-factory/index.html
[Icon]: https://maplibre.org/maplibre-native/android/api/-map-libre%20-native%20-android/org.maphero.android.annotations/-icon/index.html
...
[MarkerOptions]: https://maplibre.org/maplibre-native/android/api/-map-libre%20-native%20-android/org.maphero.android.annotations/-marker-options/index.html
[Test App]: https://github.com/maplibre/maplibre-native/tree/main/platform/android/MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/annotation/JsonApiActivity.kt
