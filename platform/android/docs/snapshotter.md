...
This guide will help you walk through how to use [MapSnapshotter](https://maplibre.org/maplibre-native/android/api/-map-libre%20-native%20-android/org.maphero.android.snapshotter/-map-snapshotter/index.html).
...
```kotlin
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/snapshot/MapSnapshotterLocalStyleActivity.kt:readStyleJson"
```

Next, we configure the MapSnapshotter, passing height and width, the style we just read and the camera position:

```kotlin
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/snapshot/MapSnapshotterLocalStyleActivity.kt:createMapSnapshotter"
```
...
```kotlin
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/snapshot/MapSnapshotterLocalStyleActivity.kt:createSnapshot"
```
...
```kotlin
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/snapshot/MapSnapshotterActivity.kt:styleBuilder"
```

Next we create a `MapSnapshotter.Options` object to customize the settings of each snapshot(ter).

```kotlin
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/snapshot/MapSnapshotterActivity.kt:mapSnapShotterOptions"
```

For some rows we randomize the visible region of the snapshot:

```kotlin
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/snapshot/MapSnapshotterActivity.kt:setRegion"
```

For some columns we randomize the camera position:

```kotlin
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/snapshot/MapSnapshotterActivity.kt:setCameraPosition"
```

In the last column of the first row we add two bitmaps. See the next example for more details.

```kotlin
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/snapshot/MapSnapshotterActivity.kt:addMarkerLayer"
```
...
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/snapshot/MapSnapshotterBitMapOverlayActivity.kt"
```
...
```kotlin
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/snapshot/MapSnapshotterHeatMapActivity.kt:class_declaration"
```

In the `onCreate` method, we set up the layout and initialize the `MapSnapshotter` once the layout is ready.

```kotlin
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/snapshot/MapSnapshotterHeatMapActivity.kt:onCreate"
```
...
```kotlin
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/snapshot/MapSnapshotterHeatMapActivity.kt:heatmapLayer"
```
...
```kotlin
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/snapshot/MapSnapshotterHeatMapActivity.kt:earthquakeSource"
```
...
```kotlin
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/snapshot/MapSnapshotterHeatMapActivity.kt:onSnapshotReady"
```

Finally, we ensure to cancel the snapshotter in the `onStop` method to free up resources.

```kotlin
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/snapshot/MapSnapshotterHeatMapActivity.kt:onStop"
```
...
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/turf/MapSnapshotterWithinExpression.kt"
```
