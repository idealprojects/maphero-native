...
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/style/AnimatedSymbolLayerActivity.kt:latLngInBounds"
```

```kotlin title="Adding a passenger at a random location (on screen)"
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/style/AnimatedSymbolLayerActivity.kt:addPassenger"
```

Adding the taxi on screen is done very similarly.

```kotlin title="Adding the taxi with bearing"
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/style/AnimatedSymbolLayerActivity.kt:addTaxi"
```
...
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/style/AnimatedSymbolLayerActivity.kt:animateTaxi"
```
