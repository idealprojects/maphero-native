...
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/style/CircleLayerActivity.kt:addBusStopSource"
```
...
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/style/CircleLayerActivity.kt:addBusStopCircleLayer"
```
...
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/style/CircleLayerActivity.kt:addClusteredSource"
```
...
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/style/CircleLayerActivity.kt:unclusteredLayer"
```
...
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/style/CircleLayerActivity.kt:clusteredCircleLayers"
```
...
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/style/CircleLayerActivity.kt:clusteredCircleLayersLoop"
```
