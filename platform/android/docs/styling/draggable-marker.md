...
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/style/DraggableMarkerActivity.kt:addOnMapClickListener"
```
...
```kotlin
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/style/DraggableMarkerActivity.kt:draggableSymbolsManager"
```
...
!!! tip
      See [maplibre-gestures-android](https://github.com/maplibre/maplibre-gestures-android) for the implementation details of the gestures library used by MapHero Android.
