...
```kotlin
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/events/ObserverActivity.kt:mapEvents"
```

You need to register them with these APIs:

```kotlin
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/events/ObserverActivity.kt:addListeners"
```

In this case we implement them by implementing the interfaces below in the activity class, but you could also use lambdas.

```kotlin
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/events/ObserverActivity.kt:ObserverActivity"
```
...
```kotlin
--8<-- "MapHeroAndroidTestApp/src/main/java/org/maphero/android/testapp/activity/events/ObserverActivity.kt:renderStatsTracker"
```
