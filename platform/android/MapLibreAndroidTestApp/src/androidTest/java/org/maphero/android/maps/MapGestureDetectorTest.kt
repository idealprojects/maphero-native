...
import org.maphero.android.maps.GesturesUiTestUtils.move
import org.maphero.android.maps.GesturesUiTestUtils.quickScale
import org.maplibre.android.testapp.R
import org.maphero.android.testapp.activity.BaseTest
import org.maphero.android.testapp.activity.maplayout.SimpleMapActivity
...
class MapGestureDetectorTest : BaseTest() {
    ...
    fun quickZoom_ignoreDoubleTap() {
        ...
        R.id.mapView.loopFor(MapHeroConstants.ANIMATION_DURATION.toLong())
        rule.runOnUiThread {
            Assert.assertTrue(maplibreMap.cameraPosition.zoom < initialZoom!!)
        }
    }
