...
import org.maphero.android.testapp.activity.espresso.PixelTestActivity
...
class VisibleRegionTest : BaseTest() {
    ...
    fun paddedTopVisibleRegionOverDatelineTest() {
        validateTestSetup()
        invoke(maplibreMap) { ui: UiController, maplibreMap: MapHeroMap ->
            maplibreMap.moveCamera(CameraUpdateFactory.newLatLngZoom(LatLng(0.0, 180.0), 8.0))
    ...
    private fun MapHeroMap.getLatLngFromScreenCoords(x: Float, y: Float): LatLng {
