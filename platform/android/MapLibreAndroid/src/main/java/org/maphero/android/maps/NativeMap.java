...
interface NativeMap {
  ...
  void setOnFpsChangedListener(@NonNull MapHeroMap.OnFpsChangedListener listener);
  ...
  void addSnapshotCallback(@NonNull MapHeroMap.SnapshotReadyCallback callback);
}