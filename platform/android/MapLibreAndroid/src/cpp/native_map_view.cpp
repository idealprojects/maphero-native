...
void NativeMapView::addLayer(JNIEnv& env, jlong nativeLayerPtr, const jni::String& before) {
    ...
    try {
        ...
        jni::ThrowNew(
            env, jni::FindClass(env, "org/maphero/android/style/layers/CannotAddLayerException"), error.what());
    }
}
...
void NativeMapView::addLayerAbove(JNIEnv& env, jlong nativeLayerPtr, const jni::String& above) {
    ...
    if (index + 1 > layers.size()) {
        // Not found
        jni::ThrowNew(env,
                      jni::FindClass(env, "org/maphero/android/style/layers/CannotAddLayerException"),
...
void NativeMapView::addSource(JNIEnv& env, const jni::Object<Source>& obj, jlong sourcePtr) {
    ...
    try {
        ...
        jni::ThrowNew(
            env, jni::FindClass(env, "org/maphero/android/style/sources/CannotAddSourceException"), error.what());
    }
}
