...
/**
 The ``MHCoordinateFormatter`` class provides properly formatted descriptions of
 ...
 */
MH_EXPORT
@interface MHCoordinateFormatter : NSFormatter
...
/**
 This method is not supported for the ``MHCoordinateFormatter`` class.
 */
