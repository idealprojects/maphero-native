...
@implementation MHCompassDirectionFormatter
...
- (NSString *)stringFromDirection:(CLLocationDirection)direction {
    ...
    dispatch_once(&onceToken, ^{
        ...
        MHAssert(shortStrings.count == longStrings.count, @"Long and short compass direction string arrays must have the same size.");
    });
...
- (BOOL)getObjectValue:(out id __nullable * __nullable)obj forString:(NSString *)string errorDescription:(out NSString * __nullable * __nullable)error {
    MHAssert(NO, @"-getObjectValue:forString:errorDescription: has not been implemented");
    return NO;
}
