...
@class MHAttributedExpression;

NS_ASSUME_NONNULL_BEGIN

typedef NSString *MHExpressionInterpolationMode NS_TYPED_ENUM;
...
+ (instancetype)mgl_expressionForConditional:(nonnull NSPredicate *)conditionPredicate
    ...
    NS_SWIFT_NAME(init(forMHConditional:trueExpression:falseExpression:));
...
+ (instancetype)mgl_expressionForSteppingExpression:(nonnull NSExpression *)steppingExpression
    ...
    NS_SWIFT_NAME(init(forMHStepping:from:stops:));
...
/**
 ...
 @param curveType The curve type could be ``MHExpressionInterpolationModeLinear``,
 ``MHExpressionInterpolationModeExponential`` and
 ``MHExpressionInterpolationModeCubicBezier``.
 @param parameters The parameters expression.
 @param stops The stops expression.

 #### Related examples
 TODO: Create a heatmap layer, learn how to style an ``MHHeatmapStyleLayer``
...
+ (instancetype)mgl_expressionForInterpolatingExpression:(nonnull NSExpression *)inputExpression
                                           withCurveType:
                                               (nonnull MHExpressionInterpolationMode)curveType
                                              parameters:(nullable NSExpression *)parameters
                                                   stops:(nonnull NSExpression *)stops
    NS_SWIFT_NAME(init(forMHInterpolating:curveType:parameters:stops:));
...
+ (instancetype)mgl_expressionForMatchingExpression:(nonnull NSExpression *)inputExpression
    ...
    NS_SWIFT_NAME(init(forMHMatchingKey:in:default:));

/**
 Returns an attributed function expression specifying an ``MHAttributedExpression`` constant
 expression array.

 @param attributedExpressions The ``MHAttributedExpression`` constant expression array.
 */
 ...
 */
+ (instancetype)expressionWithMHJSONObject:(id)object NS_SWIFT_NAME(init(mglJSONObject:));
