...
/**
 The ``MHOverlay`` protocol defines a specific type of annotation that represents
 ...
 */
@protocol MHOverlay <MHAnnotation>
 ...
 */
@property (nonatomic, readonly) MHCoordinateBounds overlayBounds;
