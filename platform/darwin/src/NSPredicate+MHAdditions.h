...
@interface NSPredicate (MHAdditions)
...
/**
 ...
 with the ``MHVectorStyleLayer/predicate`` property.
 */
+ (instancetype)predicateWithMHJSONObject:(id)object NS_SWIFT_NAME(init(mglJSONObject:));
