...
static NSString * const MHCollisionBehaviorPre4_0Key = @"MHCollisionBehaviorPre4_0";
static NSString * const MHIdeographicFontFamilyNameKey = @"MHIdeographicFontFamilyName";

@implementation MHRendererConfiguration
...
- (nullable NSString *)localFontFamilyName {
    id infoDictionaryObject = [NSBundle.mainBundle objectForInfoDictionaryKey:MHIdeographicFontFamilyNameKey];
...
- (BOOL)perSourceCollisions {
    id infoDictionaryObject = [NSBundle.mainBundle objectForInfoDictionaryKey:MHCollisionBehaviorPre4_0Key];
...
- (BOOL)perSourceCollisionsWithInfoDictionaryObject:(nullable id)infoDictionaryObject {
    ...
    if ([NSUserDefaults.standardUserDefaults objectForKey:MHCollisionBehaviorPre4_0Key]) {
        return [NSUserDefaults.standardUserDefaults boolForKey:MHCollisionBehaviorPre4_0Key];
