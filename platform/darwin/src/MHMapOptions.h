...
/**
 The ``MHMapOptions`` object provides a way to set map properties for each instance
 */
MH_EXPORT
@interface MHMapOptions : NSObject
 ...
 */
@property (nonatomic, nonnull) MHActionJournalOptions *actionJournalOptions;
