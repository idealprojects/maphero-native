...
/**
 ...
 let region = MHShapeOfflineRegion(styleURL: MHStyle.lightStyleURL, shape: triangle,
 ...
 This class requires fewer resources than MHTilePyramidOfflineRegion
 for irregularly shaped regions.
 */
MH_EXPORT
@interface MHShapeOfflineRegion : NSObject <MHOfflineRegion, NSSecureCoding, NSCopying>

/**
 The shape for the geographic region covered by the downloaded
 tiles.
 */
@property (nonatomic, readonly) MHShape *shape;
...
/**
 ...
 This is the designated initializer for ``MHShapeOfflineRegion``.
