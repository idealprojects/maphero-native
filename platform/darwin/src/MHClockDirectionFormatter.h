...
/**
 The ``MHClockDirectionFormatter`` class provides properly formatted descriptions
 ...
 irrespective of the user’s orientation, use ``MHCompassDirectionFormatter``
 instead.
 */
MH_EXPORT
@interface MHClockDirectionFormatter : NSFormatter
...
/**
 This method is not supported for the ``MHClockDirectionFormatter`` class.
 */
