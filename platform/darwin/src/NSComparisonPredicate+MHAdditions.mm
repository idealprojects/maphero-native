#import "NSComparisonPredicate+MHAdditions.h"
...
@implementation NSComparisonPredicate (MHAdditions)
...
@implementation NSComparisonPredicate (MHExpressionAdditions)
    ...
    switch (self.predicateOperatorType) {
        ...
        case NSInPredicateOperatorType: {
            ...
            if (self.leftExpression.expressionType == NSConstantValueExpressionType &&
                ...
                NSExpression *rightLiteralExpression = [NSExpression expressionWithFormat:@"MH_FUNCTION('literal', %@)", self.rightExpression];
