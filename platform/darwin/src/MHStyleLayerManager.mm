...
#import "MHBackgroundStyleLayer_Private.h"
#import "MHCircleStyleLayer_Private.h"
#import "MHFillExtrusionStyleLayer_Private.h"
#import "MHFillStyleLayer_Private.h"
#import "MHHeatmapStyleLayer_Private.h"
#import "MHHillshadeStyleLayer_Private.h"
#import "MHLineStyleLayer_Private.h"
#import "MHRasterStyleLayer_Private.h"
#import "MHSymbolStyleLayer_Private.h"
...
#if defined(MH_LAYER_CUSTOM_DRAWABLE_DISABLE_RUNTIME)
    addLayerTypeCoreOnly(std::make_unique<CustomDrawableLayerFactory>());
#elif !defined(MH_LAYER_CUSTOM_DRAWABLE_DISABLE_ALL)
    addLayerType(std::make_unique<CustomDrawableStyleLayerPeerFactory>());
#endif

    // glTF building models rendered in-map ("model3d").
    addLayerType(std::make_unique<Model3DStyleLayerPeerFactory>());
}

LayerManagerDarwin::~LayerManagerDarwin() = default;

MHStyleLayer* LayerManagerDarwin::createPeer(style::Layer* layer) {
