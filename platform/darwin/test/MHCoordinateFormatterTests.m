...
@interface MHCoordinateFormatterTests : XCTestCase

@end

@implementation MHCoordinateFormatterTests

- (void)testStrings {
    MHCoordinateFormatter *shortFormatter = [[MHCoordinateFormatter alloc] init];
    ...
    MHCoordinateFormatter *mediumFormatter = [[MHCoordinateFormatter alloc] init];
    XCTAssertEqual(mediumFormatter.unitStyle, NSFormattingUnitStyleMedium, @"Unit style should be medium by default.");

    MHCoordinateFormatter *longFormatter = [[MHCoordinateFormatter alloc] init];
