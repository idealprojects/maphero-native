...
- (void)testTileSetFromTileURLTemplatesVectorEncodings {
    ...
    tileSet = MHTileSetFromTileURLTemplates(tileURLTemplates, @{
        MHVectorTileSourceOptionEncoding: @(MHVectorTileSourceEncodingMapbox),
    });
    ...
    // when the raster encoding is changed using an NSNumber
    tileSet = MHTileSetFromTileURLTemplates(tileURLTemplates, @{
        MHVectorTileSourceOptionEncoding: @(MHVectorTileSourceEncodingMLT),
    });
    ...
    // when the raster encoding is changed using an NSValue
    MHVectorTileSourceEncoding mlt = MHVectorTileSourceEncodingMLT;
    tileSet = MHTileSetFromTileURLTemplates(tileURLTemplates, @{
        MHVectorTileSourceOptionEncoding: [NSValue value:&mlt withObjCType:@encode(MHVectorTileSourceEncoding)],
    });
