...
@interface MHMapCameraTests : XCTestCase

@end

@implementation MHMapCameraTests
...
- (void)testEyeCoordinateInitialization {
    ...
    MHMapCamera *camera = [MHMapCamera cameraLookingAtCenterCoordinate:fountainSquare
    ...
    camera = [MHMapCamera cameraLookingAtCenterCoordinate:fountainSquare
