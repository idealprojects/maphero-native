...
@interface MHCompassDirectionFormatterTests : XCTestCase

@end

@implementation MHCompassDirectionFormatterTests

- (void)testCompassDirections {
    MHCompassDirectionFormatter *shortFormatter = [[MHCompassDirectionFormatter alloc] init];
    shortFormatter.unitStyle = NSFormattingUnitStyleShort;

    MHCompassDirectionFormatter *mediumFormatter = [[MHCompassDirectionFormatter alloc] init];
    XCTAssertEqual(mediumFormatter.unitStyle, NSFormattingUnitStyleMedium, @"Unit style should be medium by default.");

    MHCompassDirectionFormatter *longFormatter = [[MHCompassDirectionFormatter alloc] init];
